          ...
          for nondep in [false, true] do
            for flag in [false, true] do
              ...
              for body in invalid do
                ...
                rejected := rejected + 1
  unless comparisons == 2688 && rejected == 2880 do
    throwError "unexpected counts {comparisons}, {rejected}"
  Lean.logInfo m!"{comparisons} native/Boolean-input predicate nested-call syntax comparisons and {rejected} invalid-input tests passed"
