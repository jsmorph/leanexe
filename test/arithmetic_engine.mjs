...
const allEntries = ['booleanPredicateCompose', 'booleanPredicateComposeRepeat', 'booleanPredicateComposeNot', 'booleanPredicateComposeCapture', 'booleanPredicateComposeBody', 'booleanPredicateComposeId', 'booleanPredicateNot', 'booleanPredicateNotTwice', 'booleanPredicateNotThrice', 'booleanPredicateNotCapture', 'booleanPredicateNotNested', 'booleanPredicateNotId', 'booleanPredicateTwice', 'booleanPredicateCapture', 'booleanPredicateWordCapture', 'booleanPredicateNested', 'booleanPredicateScalarCapture', 'booleanPredicateShadow', 'booleanPredicateDependent', 'booleanPredicateId', 'booleanPredicateUnused', 'booleanPredicateDo', 'boolWordBooleanHelper', 'constant', 'wrapping', 'quotient', 'remainder', 'shifts', 'nested', 'order',
