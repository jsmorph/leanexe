...
const allEntries = ['booleanPredicateLet', 'booleanPredicateLetNested', 'booleanPredicateLetChoice', 'booleanPredicateLetCapture', 'booleanPredicateLetUnused', 'booleanPredicateLetBody', 'booleanPredicateProposition', 'booleanPredicatePropositionDependent', 'booleanPredicatePropositionNested', 'booleanPredicatePropositionArgument', 'booleanPredicatePropositionCapture', 'booleanPredicatePropositionBody', 'booleanPredicateChoice', 'booleanPredicateChoiceDependent', 'booleanPredicateChoiceNested', 'booleanPredicateChoiceArgument', 'booleanPredicateChoiceBranches', 'booleanPredicateChoiceBody', 'booleanPredicateEqual', 'booleanPredicateDecideEqual', 'booleanPredicateEqualityNot', 'booleanPredicateEqualityMixed', 'booleanPredicateEqualityArgument', 'booleanPredicateEqualityBody', 'booleanPredicateAndOr', 'booleanPredicateJunctionNot', 'booleanPredicateJunctionMixed', 'booleanPredicateJunctionArgument', 'booleanPredicateJunctionBody', 'booleanPredicateJunctionId', 'booleanPredicateCompose', 'booleanPredicateComposeRepeat', 'booleanPredicateComposeNot', 'booleanPredicateComposeCapture', 'booleanPredicateComposeBody', 'booleanPredicateComposeId', 'booleanPredicateNot', 'booleanPredicateNotTwice', 'booleanPredicateNotThrice', 'booleanPredicateNotCapture', 'booleanPredicateNotNested', 'booleanPredicateNotId', 'booleanPredicateTwice', 'booleanPredicateCapture', 'booleanPredicateWordCapture', 'booleanPredicateNested', 'booleanPredicateScalarCapture', 'booleanPredicateShadow', 'booleanPredicateDependent', 'booleanPredicateId', 'booleanPredicateUnused', 'booleanPredicateDo', 'boolWordBooleanHelper', 'constant', 'wrapping', 'quotient', 'remainder', 'shifts', 'nested', 'order',
  ...
  'savedReannotatedDecide', 'savedReannotatedNested', 'savedReannotatedChoice', 'savedReannotatedDependentChoice', 'savedReannotatedDo', 'savedReannotatedHelper', 'savedReannotatedCaptured', 'savedReannotatedUnused', 'booleanApplyWord', 'booleanApplyBool', 'booleanApplyCapture', 'booleanApplyNested', 'booleanApplyDependent', 'booleanApplyId', 'booleanApplyUnused', 'booleanApplyDo', 'predicateInputRepeated', 'predicateInputNested', 'predicateInputCapture', 'predicateInputShadow', 'predicateInputUnused', 'predicateInputDo', 'reusableBooleanTwice', 'reusableBooleanCapture', 'reusableBooleanNested', 'reusableBooleanScalarCapture', 'reusableBooleanShadow', 'reusableBooleanDependent', 'reusableBooleanId', 'reusableBooleanUnused', 'reusableBooleanIgnoredArgument', 'reusableBooleanDo', 'namedBooleanWord', 'namedBooleanBool', 'namedBooleanCapture', 'namedBooleanNested', 'namedBooleanDependent', 'namedBooleanId', 'namedBooleanUnused', 'namedBooleanDo', ...rangeEntries];
