...
run_elab do
  ...
  Lean.logInfo m!"{comparisons} native/Boolean-input step predicate let syntax comparisons and {rejected} invalid-input tests and {controls} admission controls passed"
