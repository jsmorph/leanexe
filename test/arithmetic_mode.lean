...
run_elab do
  ...
  for name in [`ArithmeticModeTest.expression, `ArithmeticModeTest.bits, `ArithmeticModeTest.literal,
      ...
      `ArithmeticModeTest.dependentReannotatedEq,
      `ArithmeticModeTest.dependentReannotatedOrder,
      `ArithmeticModeTest.dependentReannotatedCompound,
      `ArithmeticModeTest.dependentReannotatedNested,
      `ArithmeticModeTest.dependentReannotatedHelper,
      `ArithmeticModeTest.dependentReannotatedDo,
      `ArithmeticModeTest.savedReannotatedDecide,
      `ArithmeticModeTest.savedReannotatedNested,
      `ArithmeticModeTest.savedReannotatedChoice,
      `ArithmeticModeTest.savedReannotatedDependentChoice,
      `ArithmeticModeTest.savedReannotatedDo,
      `ArithmeticModeTest.savedReannotatedHelper,
      `ArithmeticModeTest.savedReannotatedCaptured,
      `ArithmeticModeTest.savedReannotatedUnused,
      ...
      `ArithmeticModeTest.booleanPredicateLet,
      `ArithmeticModeTest.booleanPredicateLetNested,
      `ArithmeticModeTest.booleanPredicateLetChoice,
      `ArithmeticModeTest.booleanPredicateLetCapture,
      `ArithmeticModeTest.booleanPredicateLetUnused,
      `ArithmeticModeTest.booleanPredicateLetBody,
      `ArithmeticModeTest.rangeBooleanPredicateLoopLetBreak,
      `ArithmeticModeTest.rangeBooleanPredicateLoopLetContinue,
      `ArithmeticModeTest.rangeBooleanPredicateLoopLetChoice,
      `ArithmeticModeTest.rangeBooleanPredicateLoopLetCapture,
      `ArithmeticModeTest.rangeBooleanPredicateOuterLetBounds,
      `ArithmeticModeTest.rangeBooleanPredicateOuterLetCapture,
      `ArithmeticModeTest.rangeBooleanPredicateOuterLetChoice,
      `ArithmeticModeTest.rangeBooleanPredicateOuterLetId,
      `ArithmeticModeTest.rangeBooleanPredicateLetStep,
      `ArithmeticModeTest.rangeBooleanPredicateLetContinue,
      `ArithmeticModeTest.rangeBooleanPredicateLetOuter,
      `ArithmeticModeTest.rangeBooleanPredicateLetOuterCapture,
      `ArithmeticModeTest.booleanPredicateProposition,
      `ArithmeticModeTest.booleanPredicatePropositionDependent,
      `ArithmeticModeTest.booleanPredicatePropositionNested,
      `ArithmeticModeTest.booleanPredicatePropositionArgument,
      `ArithmeticModeTest.booleanPredicatePropositionCapture,
      `ArithmeticModeTest.booleanPredicatePropositionBody,
      `ArithmeticModeTest.rangeBooleanPredicatePropositionStep,
      `ArithmeticModeTest.rangeBooleanPredicatePropositionContinue,
      `ArithmeticModeTest.rangeBooleanPredicatePropositionOuter,
      `ArithmeticModeTest.rangeBooleanPredicatePropositionOuterCapture,
      ...
      `ArithmeticModeTest.booleanPredicateEqualityMixed,
      `ArithmeticModeTest.booleanPredicateEqualityArgument,
      `ArithmeticModeTest.booleanPredicateEqualityBody,
      `ArithmeticModeTest.rangeBooleanPredicateEqualityStep,
      `ArithmeticModeTest.rangeBooleanPredicateEqualityContinue,
      `ArithmeticModeTest.rangeBooleanPredicateEqualityOuter,
      `ArithmeticModeTest.rangeBooleanPredicateEqualityOuterCapture,
      ...
      `ArithmeticModeTest.booleanPredicateNotCapture,
      `ArithmeticModeTest.booleanPredicateNotNested,
      `ArithmeticModeTest.booleanPredicateNotId,
      `ArithmeticModeTest.rangeBooleanPredicateNotStep,
      `ArithmeticModeTest.rangeBooleanPredicateNotContinue,
      `ArithmeticModeTest.rangeBooleanPredicateNotOuter,
      `ArithmeticModeTest.rangeBooleanPredicateNotOuterCapture,
      ...
      `ArithmeticModeTest.rangeBooleanPredicateNested,
      `ArithmeticModeTest.rangeBooleanPredicateStepHelper,
      `ArithmeticModeTest.rangeBooleanPredicateUnused,
      ...
      `ArithmeticModeTest.predicateInputShadow,
      `ArithmeticModeTest.predicateInputUnused,
      `ArithmeticModeTest.predicateInputDo,
      `ArithmeticModeTest.rangePredicateInputStep,
      `ArithmeticModeTest.rangePredicateInputStepCapture,
      `ArithmeticModeTest.rangePredicateInputOuter,
      `ArithmeticModeTest.rangePredicateInputOuterCapture,
      `ArithmeticModeTest.rangeOuterPredicateBounds,
      `ArithmeticModeTest.rangeOuterPredicateCapture,
      `ArithmeticModeTest.rangeOuterPredicateNested,
      `ArithmeticModeTest.rangeOuterPredicateShadow,
      `ArithmeticModeTest.rangeOuterPredicateUnused,
      `ArithmeticModeTest.rangeOuterPredicateScalarHelper,
      `ArithmeticModeTest.rangeOuterPredicateId,
      `ArithmeticModeTest.rangeOuterPredicateStride,
      ...
      `ArithmeticModeTest.namedBooleanNested,
      `ArithmeticModeTest.namedBooleanDependent,
      `ArithmeticModeTest.namedBooleanId,
      `ArithmeticModeTest.namedBooleanUnused,
      `ArithmeticModeTest.namedBooleanDo,
      `ArithmeticModeTest.rangeNamedBooleanBreak,
      `ArithmeticModeTest.rangeNamedBooleanContinue,
      `ArithmeticModeTest.rangeNamedBooleanCapture,
