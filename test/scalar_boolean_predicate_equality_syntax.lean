...
run_elab do
  ...
  Lean.logInfo m!"{comparisons} native/Boolean-input predicate equality syntax comparisons and {rejected} invalid-input tests and {controls} admission controls passed"
