...
const auditedTheorems = [
  ...
  "step_structEq",
  "step_structEq_right",
  "step_structEq_result",
  "step_structEq_true_iff",
  "step_structEq_false_iff",
  "Steps.trans",
  ...
  "Renaming.liftN_prefix",
  "Renaming.liftN_suffix",
  "Renaming.liftN_preimage_prefix",
  "Renaming.liftN_preimage_suffix",
  "Renaming.exists_liftN_suffix",
  "Renaming.occurrenceImage_or",
  "Renaming.occurrenceImage_false",
  "uses_rename_iff",
  "usesArgs_rename_iff",
  "usesBranches_rename_iff",
  "Renaming.bool_eq_of_true_iff",
  "uses_rename_liftN_prefix",
  "parametersUsed_rename_liftN",
  "admissible_rename",
  "admissibleArgs_rename",
  "admissibleBranches_rename",
  "ProfileTyped.rename",
  "ProfileTyped.weaken",
  "EnvCorresponds.lookup",
  "EnvCorresponds.refl",
  "EnvCorresponds.empty",
  "EnvCorresponds.comp",
  "EnvCorresponds.lift",
  "EnvCorresponds.prefix",
  "EnvCorresponds.shift",
  "renameBranches_lookup",
