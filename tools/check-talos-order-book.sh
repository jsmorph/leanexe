...
wasm_tmp="$repo_root/.lake/build/talos-order-book/check.program.wasm"
wat_tmp="$repo_root/.lake/build/talos-order-book/check.program.wat"
wasm_ref="$repo_root/proofs/talos-gcd/rust/build/order_book/program.wasm"
wat_ref="$repo_root/proofs/talos-gcd/rust/build/order_book/program.wat"
...
lake build LeanExe.Examples.OrderBook lean-wasm
...
lake build Project.OrderBook.Spec
