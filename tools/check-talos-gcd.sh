...
wasm_tmp="$repo_root/.lake/build/talos-gcd/check.program.wasm"
wat_tmp="$repo_root/.lake/build/talos-gcd/check.program.wat"
wasm_ref="$repo_root/proofs/talos-gcd/rust/build/gcd/program.wasm"
wat_ref="$repo_root/proofs/talos-gcd/rust/build/gcd/program.wat"
...
lake build LeanExe.Examples.TalosGcd lean-wasm
