...
| Polymorphism | Concrete type arguments now specialize supported user-defined structures, nonrecursive inductives, and recursive inductive families.  Generic runtime functions, escaping polymorphic values, and typeclass-driven runtime dispatch remain unsupported, so broad generic library code still needs explicit specialization work. | Monomorphic library instances compile today, and later function monomorphization and typeclass specialization have specified acceptance and rejection rules. |
