...
Current artifact-level experiments use Talos to prove properties of selected WASM modules generated by LeanExe.  See [Talos Proofs](proofs/talos-gcd/README.md) for the GCD, association-list, and order-book proofs.  Those proofs exercise generated artifacts while the general source-to-WASM theorem remains the target for this plan.
