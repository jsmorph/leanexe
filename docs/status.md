...
contain 37 complete source cases, one incomplete Riemann
case, 38 caches, 17 completed FP cases, and 33 exact-byte packages.

The [complete Riemann solver](../plans/euler-riemann-complete.md) moves
