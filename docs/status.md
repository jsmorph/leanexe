...
This report describes the `iogpt` merge on 2026-09-25.  The root [Development Plan](../plan.md) records remaining work.  Repository registries define the source and exact-artifact proof inventories.
