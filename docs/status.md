...
I/O and quantized GPT from `iogpt`. Integration checks pass on `ciogpt` at
`cbefab5e`; [the evidence archive](../proofs/compiler/ciogpt-2026-09-25/README.md)
records fresh compiler, I/O, running-sum, GPT identity and execution checks.
The broader parent verification records describe their respective revisions;
the current handoff is in [task.md](../task.md). The root
