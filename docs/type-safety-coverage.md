...
| Sequencing | Continuation extension for successful steps/traces; exact finite decomposition at the empty-return boundary; return/overflow/stuck sequencing equivalences. | Individual derived-form expansions and their exact behavior still need proofs. No termination claim. |
