...
| `OPA-009` | Separate compact suffix theorem | Completed fold frame before result placement and the public continuation | Accepted and independently verified on Demo 10.  An inline compact consequence retained the six-gibibyte elaboration failure, while a preceding theorem declaration restored ordinary diagnostics and allowed the artifact proof to complete. |
