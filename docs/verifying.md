...
Those older aggregate results are historical: twenty cases passed on 2026-08-26 and twenty-six on 2026-09-04.  The current gate regenerates thirty-one cases and builds their completed specifications.  On 2026-09-07 regeneration passed, but the build reached its 20-minute limit while compiling existing CLOB dependencies without a theorem diagnostic; smaller missing targets must complete before a retry.
