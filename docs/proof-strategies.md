...
Eleven frozen `leanexegen` demonstrations add acceptance evidence for the generated array ABI and structured proof support.  Demo 1 combines a scalar computation with a singleton wrapper, Demo 2 proves an unrolled association-list search and two-word result, and Demos 4–11 exercise maps, filters, scalar loops, counter transfer, and folds.  The [demonstration index](../demos/README.md) defines each program and links to its representative proof and retained experiments.
