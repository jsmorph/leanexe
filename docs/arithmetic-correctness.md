...
and all reserved names, compiles 128 fresh declarations with that command,
...
It is configured to compare 2,580 results against native Lean evaluation, including overflow, zero
...
checks the fixed range fixture group: 2,017 results across eighty-five declarations,
