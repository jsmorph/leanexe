...
`LeanExe.Examples.JsonTools.transform : ByteArray -> ByteArray` demonstrates generated JSON output through `object1UInt64`.  `LeanExe.Examples.JsonTools.lookup : ByteArray -> UInt64` demonstrates generic object-field lookup, including skipping an unknown nested object before the requested field.
