...
| Pattern matching | Planned | Implemented for `Bool`, `Option`, and nonrecursive zero/successor `Nat` matches in the generic path and for the demo range check path |
