...
| `Array` | Planned with explicit layout rules | Implemented only for `Array UInt64` in the generic fragment, with zero-filled allocation, `Array.size`, length metadata, bounds traps, and copy-on-write update |
