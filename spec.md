...
| `Array` | Planned with explicit layout rules | Implemented only for `Array UInt64` in the generic fragment, with zero-filled allocation, `Array.size`, `Array.push`, length metadata, bounds traps, and copy-on-write update |
