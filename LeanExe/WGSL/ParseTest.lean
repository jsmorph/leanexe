...
abbrev rectangularSource : String := RectangularArtifact.source
...
def main : IO Unit := do
  let actual ← IO.FS.readBinFile "test/wgsl/artifacts/rectangular/kernel.wgsl"
  unless actual == LeanExe.WGSL.ParseTest.rectangularSource.toUTF8 do
