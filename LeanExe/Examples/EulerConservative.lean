...
namespace LeanExe.Examples.EulerConservative
...
def sideCheckedBits (rho momentum energy : UInt64) : CheckedSideBits :=
  if stateGuard rho momentum energy then
    ...
    let halfKinetic := LeanExe.Float64.mulBits 0x3FE0000000000000 transport
...
end LeanExe.Examples.EulerConservative
