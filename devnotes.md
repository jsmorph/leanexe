...
The first fresh complete-starter run finished Stage 5 in 109.607 seconds, including 72.398 seconds in Codex and 27.589 seconds in outer acceptance.  The initial build passed, Codex made no proof edit, the published proof contained 77 lines, and independent verification accepted the package.  The result is 216.713 seconds below the preceding complete-tree median and 169.049 seconds below the historical 278.656-second pair-result result; two more runs will determine the complete-starter median.
