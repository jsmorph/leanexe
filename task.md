...
Step-result preparation checkpoint: distinct result bindings, nested standard
Id wrappers, result-valued lets and binds now have checked source acceptance,
successful-extraction support, invariants and semantic preservation proofs.
The first focused execution test exposed nested Id annotations generated by
ordinary inference: Id.run can carry Id (ForInStep UInt64), with another Id
