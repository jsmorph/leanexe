...
| [Verified quantized GPT-2 124M](gpt2-quantized.md) | Scalar projection proved and measured; model integration active; expands phase 15 | Eight-bit weights and linear-layer activations, integer accumulation, FP32 surrounding computation, exact-binary cached inference, comparative evaluation, and subsequent numerical certificates.  The [file and session API](gpt2-quantized-format.md) is approved. |
