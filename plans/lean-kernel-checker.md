...
Status: M0.0–M0.6 complete on 2026-09-16. M0.7 is next. Work is committed and published on branch lean-kernel-checker after each increment.
...
- **Next task:** M0.7: capture-avoiding substitution. M0.0–M0.6 are complete, including a closed proof checked in WASM; see the checker README and journal for commands and receipts.
