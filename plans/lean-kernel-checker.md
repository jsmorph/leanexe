...
Status: M0.0–M0.7 complete on 2026-09-16. M0.8 is next. Work is committed and published on branch lean-kernel-checker after each increment.
...
- **Next task:** M0.8: application typing. M0.0–M0.7 are complete; see the checker README and journal for commands and receipts.
