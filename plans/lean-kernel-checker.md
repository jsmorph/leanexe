...
Status: M0.0–M0.3 complete on 2026-09-16. M0.4 is next. Work is committed and published on branch lean-kernel-checker after each increment.
...
- **Next task:** M0.4: validated local contexts and Sort/bvar inference. M0.0–M0.3 are complete; see the checker README and development journal for commands and receipts.
