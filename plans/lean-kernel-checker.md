...
Status: M0.0–M0.2 complete on 2026-09-16. M0.3 is next. Work is committed and published on branch lean-kernel-checker after each increment.
...
- **Next task:** M0.3: binder-aware scope and shifting. M0.0–M0.2 are complete; see the checker README and development journal for commands and receipts.
