...
exact-byte package passes.  CFL byte closure, grid-fold execution, and
solver integration remain open.  The rounded
...
The CFL byte proof and revised-solver integration remain open.
