...
exact-byte package passes, as does the mesh CFL package.  Grid-fold
execution and solver integration remain open.  The rounded
...
Grid-fold execution and revised-solver integration remain open.
