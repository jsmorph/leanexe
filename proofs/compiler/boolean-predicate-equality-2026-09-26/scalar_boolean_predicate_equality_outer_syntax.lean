...
run_elab do
            ...
            let call (argument : Lean.Expr) := toWord
              (form.local negations unequal
                ...
                (.junction (negations + 1) .disjunction
                  (.predicate 0 2 (BooleanGuardNegation.expr 1 argument))
  ...
  Lean.logInfo m!"{comparisons} native/outer Boolean-input predicate equality syntax comparisons and {rejected} invalid-input tests passed"
