...
def function_45_array_fold_0_program : Wasm.Program :=
  (Project.ProofKit.Annotation.region Project.EulerOutwardGrid.func45 [] 0 30).getD []

theorem function_45_array_fold_0_eq :
    Project.ProofKit.Annotation.region Project.EulerOutwardGrid.func45 [] 0 30 = some function_45_array_fold_0_program := by
  rfl

theorem function_45_array_fold_0_tail_eq :
    ((Project.ProofKit.Annotation.resolve Project.EulerOutwardGrid.func45 []).getD []).drop 0 =
      Project.EulerOutwardGrid.AnnotationMatches.function_45_array_fold_0_program ++ ((Project.ProofKit.Annotation.resolve Project.EulerOutwardGrid.func45 []).getD []).drop 30 := by
  rfl
