...
import Project.EulerOutwardGrid.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.EulerOutwardGrid.func0Def, Project.EulerOutwardGrid.func1Def, Project.EulerOutwardGrid.func2Def, Project.EulerOutwardGrid.func3Def, Project.EulerOutwardGrid.func4Def, Project.EulerOutwardGrid.func5Def, Project.EulerOutwardGrid.func6Def, Project.EulerOutwardGrid.func7Def, Project.EulerOutwardGrid.func8Def, Project.EulerOutwardGrid.func9Def, Project.EulerOutwardGrid.func10Def, Project.EulerOutwardGrid.func11Def, Project.EulerOutwardGrid.func12Def, Project.EulerOutwardGrid.func13Def, Project.EulerOutwardGrid.func14Def, Project.EulerOutwardGrid.func15Def, Project.EulerOutwardGrid.func16Def, Project.EulerOutwardGrid.func17Def, Project.EulerOutwardGrid.func18Def, Project.EulerOutwardGrid.func19Def, Project.EulerOutwardGrid.func20Def, Project.EulerOutwardGrid.func21Def, Project.EulerOutwardGrid.func22Def, Project.EulerOutwardGrid.func23Def, Project.EulerOutwardGrid.func24Def, Project.EulerOutwardGrid.func25Def, Project.EulerOutwardGrid.func26Def, Project.EulerOutwardGrid.func27Def, Project.EulerOutwardGrid.func28Def, Project.EulerOutwardGrid.func29Def, Project.EulerOutwardGrid.func30Def, Project.EulerOutwardGrid.func31Def, Project.EulerOutwardGrid.func32Def, Project.EulerOutwardGrid.func33Def, Project.EulerOutwardGrid.func34Def, Project.EulerOutwardGrid.func35Def, Project.EulerOutwardGrid.func36Def, Project.EulerOutwardGrid.func37Def, Project.EulerOutwardGrid.func38Def, Project.EulerOutwardGrid.func39Def, Project.EulerOutwardGrid.func40Def, Project.EulerOutwardGrid.func41Def, Project.EulerOutwardGrid.func42Def, Project.EulerOutwardGrid.func43Def, Project.EulerOutwardGrid.func44Def, Project.EulerOutwardGrid.func45Def, Project.EulerOutwardGrid.func46Def, Project.EulerOutwardGrid.func47Def, Project.EulerOutwardGrid.func48Def, Project.EulerOutwardGrid.func49Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq, function5_eq, function6_eq, function7_eq, function8_eq, function9_eq, function10_eq, function11_eq, function12_eq, function13_eq, function14_eq, function15_eq, function16_eq, function17_eq, function18_eq, function19_eq, function20_eq, function21_eq, function22_eq, function23_eq, function24_eq, function25_eq, function26_eq, function27_eq, function28_eq, function29_eq, function30_eq, function31_eq, function32_eq, function33_eq, function34_eq, function35_eq, function36_eq, function37_eq, function38_eq, function39_eq, function40_eq, function41_eq, function42_eq, function43_eq, function44_eq, function45_eq, function46_eq, function47_eq, function48_eq, function49_eq]

def executionCache : Wasm.Module :=
  Project.EulerOutwardGrid.«module»
...
theorem artifact_gridUpper_exact :
  ...
  exact artifact_correct_of Spec.ExactSpecFor Spec.gridUpper_exact

#print axioms artifact_gridUpper_exact

theorem artifact_gridUpper_behavior :
    ∃ raw validated,
      decode artifactBytes = .ok raw ∧
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Spec.BehaviorSpecFor validated.toTalos := by
  exact artifact_correct_of Spec.BehaviorSpecFor Spec.gridUpper_behavior

#print axioms artifact_gridUpper_behavior
