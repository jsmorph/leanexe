...
| `Project.ProofKit.FreeListMemory` | First-fit predecessor membership, free-list preservation under header-byte agreement and page growth, and preservation of bytes outside free-node regions during reuse. |
