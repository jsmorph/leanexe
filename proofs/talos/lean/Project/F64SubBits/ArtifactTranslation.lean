import Project.F64SubBits.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.F64SubBits.func0Def, Project.F64SubBits.func1Def, Project.F64SubBits.func2Def, Project.F64SubBits.func3Def, Project.F64SubBits.func4Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq]

def executionCache : Wasm.Module :=
  Project.F64SubBits.«module»
