...
namespace Project.PushTwice.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [112, 117, 115, 104, 84, 119, 105, 99, 101, 83, 105, 122, 101, 115],
                          text := "pushTwiceSizes" },
  ...
  codes := [{ locals := [{ count := 17, type := Wasm.Binary.ValType.i64 }],
...
end Project.PushTwice.Artifact.Cache
