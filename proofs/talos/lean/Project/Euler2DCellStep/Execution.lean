...
theorem cellCheckedBits_exact_in_module {m : Wasm.Module} (layout : Layout m)
  ...
  change TerminatesWith env m 17 initial [.i64 energy, .i64 transverse, .i64 momentum, .i64 rho, .i64 energyL, .i64 transverseL, .i64 momentumL, .i64 rhoL]
  ...
  change TerminatesWith env m 17 initial [.i64 energyR, .i64 transverseR, .i64 momentumR, .i64 rhoR, .i64 energy, .i64 transverse, .i64 momentum, .i64 rho]
  ...
  change TerminatesWith env m 20 initial [.i64 right.mass, .i64 left.mass, .i64 rho, .i64 ratio]
  ...
  change TerminatesWith env m 20 initial [.i64 right.momentum, .i64 left.momentum, .i64 momentum, .i64 ratio]
  ...
  change TerminatesWith env m 20 initial [.i64 right.transverse, .i64 left.transverse, .i64 transverse, .i64 ratio]
  ...
  change TerminatesWith env m 20 initial [.i64 right.energy, .i64 left.energy, .i64 energy, .i64 ratio]
  ...
  change TerminatesWith env m 5 initial [.i64 nextEnergy.value, .i64 nextTransverse.value, .i64 nextMomentum.value, .i64 nextDensity.value]
  ...
  change wp m func27 _ initial (func27Def.toLocals [.i64 ratio, .i64 rhoL, .i64 momentumL, .i64 transverseL, .i64 energyL, .i64 rho, .i64 momentum, .i64 transverse, .i64 energy, .i64 rhoR, .i64 momentumR, .i64 transverseR, .i64 energyR]) env
  unfold func27
  wp_run [func27Def, List.set, List.getElem?_cons_zero, List.getElem?_cons_succ,
