...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [99, 101, 108, 108, 67, 104, 101, 99, 107, 101, 100, 66, 105, 116, 115],
                ...
                desc := Wasm.Binary.ExportDesc.func 35 },
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 36 },
              { name := { bytes := [114, 101, 115, 101, 116], text := "reset" },
                desc := Wasm.Binary.ExportDesc.func 37 },
              ...
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 39 },
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.localGet 0,
                          ...
                          Wasm.Binary.Instr.iff
                            ...
                            (some [Wasm.Binary.Instr.i64Const 0, Wasm.Binary.Instr.localSet 41])]
                         (some [Wasm.Binary.Instr.i64Const 0, Wasm.Binary.Instr.localSet 41]),
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               [Wasm.Binary.Instr.localGet 25,
                                ...
                                Wasm.Binary.Instr.iff
                                  ...
                                  (some [Wasm.Binary.Instr.call 12,
                                   ...
                                   Wasm.Binary.Instr.iff
                                     ...
                                     [Wasm.Binary.Instr.localGet 65,
                                      ...
                                      Wasm.Binary.Instr.iff
                                        ...
                                        (some [Wasm.Binary.Instr.call 34,
