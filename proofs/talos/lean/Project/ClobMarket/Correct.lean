...
open Wasm Project.Common Project.Clob Project.ClobMarket
  Project.ClobMarket.Model Project.ClobMatchFuel.LoopInvariant
...
inductive OutcomeAt (initial final : Store Unit)
  ...
  | valid
      ...
      (hOutput : Project.ClobLimit.HeapRunMatch.OutputAt
        (Project.ClobLimit.HeapRunMatch.runMatchContext initial os
...
theorem func21_correct : CorrectSpec := by
  intro env st book bookCapacity g0 g2 g4 g5 os order limit hLength hBook48
    hBook32 hBookCapacity hBookBelow hBook hFit32 hFit hPages hg0 hg1 hg2 hg4 hg5 hAddressLimit hMemoryLimit hBudget
  ...
  · refine TerminatesWith.mono
    ...
    have hContext :=
      Project.ClobLimit.HeapRunMatch.runMatchContext_result st os
