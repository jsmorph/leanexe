...
namespace Project.ClobMarket.Frozen.InvalidEntry

open Wasm Project.Clob Project.ClobMarket Project.ClobPostOnly.Frozen.Model
...
theorem entryProg_invalid_spec (env : HostEnv Unit) (st : Store Unit)
    ...
    wp Project.ClobMarket.Frozen.«module» (Entry.entryProg ++ rest) Q st
...
end Project.ClobMarket.Frozen.InvalidEntry
