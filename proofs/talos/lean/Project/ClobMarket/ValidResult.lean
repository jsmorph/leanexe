...
def outputFrame (book : UInt64) (order : OrderL)
    (ctx : Context) (data : Project.ClobLimit.MatchOutput.OutputData) :
    Locals :=
  ...
  { params := [.i64 book, .i64 order.oid, .i64 order.otrader,
    ...
    locals := [
      ...
      .i64 taker.oid, .i64 taker.otrader, .i64 taker.oside, .i64 taker.oprice,
      .i64 taker.oqty, .i64 0, .i64 book, .i64 taker.oid,
      .i64 taker.otrader, .i64 taker.oside, .i64 taker.oprice, .i64 taker.oqty,
      .i64 data.bookOwner, .i64 data.book, .i64 data.tradesOwner, .i64 data.trades,
      .i64 ctx.result.remaining, .i64 data.bookOwner, .i64 data.book, .i64 data.tradesOwner,
      .i64 data.trades, .i64 0, .i64 0, .i64 0,
      .i64 0, .i64 0, .i64 data.bookOwner, .i64 data.book,
      .i64 data.tradesOwner, .i64 data.trades] ++ List.replicate 13 (.i64 0)
...
theorem validResultProg_spec (env : HostEnv Unit) (st : Store Unit)
    ...
    (values : List Value)
    (hValues : values =
      Project.ClobLimit.MatchOutput.outputValues ctx data)
  ...
  simp [Project.ClobLimit.MatchOutput.outputValues,
    Call.callFrame]
