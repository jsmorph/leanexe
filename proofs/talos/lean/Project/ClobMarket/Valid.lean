    ...
    TerminatesWith (m := Project.ClobMarket.«module») (id := 21)
      ...
      (fun st' values =>
        ∃ data,
          ...
          Project.ClobLimit.MatchOutput.OutputAt
...
theorem func21_valid : ValidSpec := by
  ...
  have hRunMatch : TerminatesWith (m := Project.ClobMarket.«module»)
      ...
      (Project.ClobLimit.MatchOutput.Postcondition ctx) := by
    apply RunMatch.func18_correct env st 0 book bookCapacity g0 g2 g4 g5 os taker
  ...
  · change wp Project.ClobMarket.«module» func21 _ st
    ...
    apply Call.callProg_spec env st book order
      (Project.ClobLimit.MatchOutput.Postcondition ctx) hRunMatch
