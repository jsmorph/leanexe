...
namespace Project.ClobMarket.Frozen.InvalidPost
...
theorem allocStore_postcondition
    ...
    Postcondition st
      (Project.ClobLimit.Frozen.RunMatchEmptyAlloc.allocStore st g0 g2)
      book bookCapacity g0 g2 os
      [.i64 (g0 + 48), .i64 book, .i64 1] := by
  unfold Postcondition
  refine ⟨rfl, ?_, ?_, ?_, rfl, ?_⟩
  · exact Project.ClobLimit.Frozen.RunMatchEmptyAlloc.ownedOrderArrayAt_allocStore
      hFit32 hBook48 hBook32 hBookCapacity hBookBelow hBook
  · exact Project.ClobLimit.Frozen.RunMatchEmptyAlloc.allocStore_empty_trade st
      g0 g2 hFit32 hFit
  · exact Project.ClobLimit.Frozen.RunMatchEmptyAlloc.allocStore_pages st g0 g2
  · intro a ha
    exact Project.ClobLimit.Frozen.RunMatchEmptyAlloc.allocStore_bytes_before st
      g0 g2 a hFit32 ha

end Project.ClobMarket.Frozen.InvalidPost
