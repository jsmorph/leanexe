...
namespace Project.ClobMarket.Frozen.InvalidProgram
...
theorem invalidProg_spec
    ...
    wp Project.ClobMarket.Frozen.«module» Entry.invalidProg Q st
...
end Project.ClobMarket.Frozen.InvalidProgram
