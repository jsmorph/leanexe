...
namespace Project.ClobMarket.Frozen.InvalidPrepare
...
theorem invalidPrepareProg_spec
    ...
    wp Project.ClobMarket.Frozen.«module» (Entry.invalidPrepareProg ++ rest) Q st
...
end Project.ClobMarket.Frozen.InvalidPrepare
