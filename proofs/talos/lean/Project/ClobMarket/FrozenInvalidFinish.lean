...
namespace Project.ClobMarket.Frozen.InvalidFinish
...
theorem invalidFinishProg_spec
    ...
    (hNext : wp Project.ClobMarket.Frozen.«module» rest Q
      (Project.ClobLimit.Frozen.RunMatchEmptyAlloc.allocStore st g0 g2)
      (finishFrame base g0) env) :
    wp Project.ClobMarket.Frozen.«module» (Entry.invalidFinishProg ++ rest) Q
