...
namespace Project.ClobMarket.Frozen.InvalidSearch
...
theorem invalidSearchProg_empty
    ...
    wp Project.ClobMarket.Frozen.«module» (Entry.invalidSearchProg ++ rest) Q st
  ...
  · rintro st' s ⟨rfl, rfl⟩
    ...
    change wp Project.ClobMarket.Frozen.«module» rest Q st'
      (Locals.mk base.params base.locals base.values) env
    rw [hFrame]
    exact hNext

end Project.ClobMarket.Frozen.InvalidSearch
