...
namespace Project.ClobMarket.Frozen.InvalidBump
...
theorem invalidBumpProg_spec
    ...
    wp Project.ClobMarket.Frozen.«module» (Entry.invalidBumpProg ++ rest) Q st
      base env := by
...
end Project.ClobMarket.Frozen.InvalidBump
