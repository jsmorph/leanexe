...
import Project.ClobMatchFuel.FrozenMemoryFrame
...
namespace Project.ClobMatchFuel.Frozen.FullTradeUpdate
...
open Wasm Project.Common Project.Runtime Project.Clob Project.ClobMatchFuel
  ...
  Project.ClobMatchFuel.Frozen.MemoryFrame
...
theorem fullTradeUpdateProg_spec
  ...
  · intro previous st1 hTarget48 hTarget32 hTargetFit hOldTradesAlloc
    ...
    have hNodesBelowFinal : ∀ node ∈ nodes,
      ...
      omega
    have hPagesFinal : finalStore.mem.pages = st.mem.pages :=
      hFinalPages.trans (AllocatorFrame.fixedArrayAllocBumpStore_pages st g0
...
end Project.ClobMatchFuel.Frozen.FullTradeUpdate
