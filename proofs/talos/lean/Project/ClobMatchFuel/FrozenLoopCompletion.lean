...
namespace Project.ClobMatchFuel.Frozen.LoopCompletion

open Wasm Project.Clob Project.Runtime Project.ClobFindBest.Frozen.Model
  Project.ClobMatchFuel Project.ClobMatchFuel.Frozen.LoopInvariant
...
end Project.ClobMatchFuel.Frozen.LoopCompletion
