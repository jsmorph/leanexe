...
namespace Project.ClobMatchFuel.Frozen.FullBranch
...
theorem fullBookThenTrade_spec
  ...
  · intro previous st1 hTarget48 hTarget32 hNewBookOwned hBookOwned1
    ...
    · intro st2 s newTrades newTradesCapacity nodes2 g0Final hResult hScratch
      ...
      · calc
          g0Final.toNat ≤ g0AfterBook.toNat + 48 +
              tradeArrayBytes (ts.length + 1) := hHeapUpper
          _ = g0.toNat + 96 + orderArrayBytes (os.length - 1) +
...
end Project.ClobMatchFuel.Frozen.FullBranch
