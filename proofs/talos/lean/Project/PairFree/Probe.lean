...
private theorem buildsCells (M : Mem) (stB : Store Unit)
...
private theorem buildsPhase2 (env : HostEnv Unit) (st1 st2 : Store Unit)
  ...
  · rintro stX sX ⟨rfl, rfl⟩
    ...
    simp only [(buildsCells _ stB g0 bytes hFit32 hszU hszN_ge hszN_ge8 hg0_32 PB.2.2.2.2.2.2.2.2.1 PB.2.2.2.2.2.2.2.2.2.2.2.2.2 rfl).1]
    refine wp_iff_cons rfl ?_
    ...
    try simp
    try simp only [hTrap, if_false, false_and, and_false]
    have hmagic2e := (buildsCells _ stB g0 bytes hFit32 hszU hszN_ge hszN_ge8 hg0_32 PB.2.2.2.2.2.2.2.2.1 PB.2.2.2.2.2.2.2.2.2.2.2.2.2 rfl).2.1
    rw [hstB] at hmagic2e
    dsimp only at hmagic2e
    try simp only [(buildsCells _ stB g0 bytes hFit32 hszU hszN_ge hszN_ge8 hg0_32 PB.2.2.2.2.2.2.2.2.1 PB.2.2.2.2.2.2.2.2.2.2.2.2.2 rfl).2.1, hmagic2e]
    try wp_run_big
    try simp only [hTrap, if_false, false_and, and_false]
    try simp
    try simp only [hTrap, if_false, false_and, and_false]
    ...
    try simp only [hTrap, if_false, false_and, and_false]
    refine ⟨by omega, ?_⟩
    have hrc2e := (buildsCells _ stB g0 bytes hFit32 hszU hszN_ge hszN_ge8 hg0_32 PB.2.2.2.2.2.2.2.2.1 PB.2.2.2.2.2.2.2.2.2.2.2.2.2 rfl).2.2
    ...
    try simp
    try simp only [hTrap, if_false, false_and, and_false]
    refine ⟨?_, hDone _ _ ?_⟩
    · rw [hsub40, PB.2.1]
      omega
    have h0B := PB.2.2.2.2.2.1
    have h2B := PB.2.2.2.2.2.2.1
    have h3B := PB.2.2.2.2.2.2.2.1
    have hh0B := PB.2.2.2.2.2.2.2.2.1
    have hh24B := PB.2.2.2.2.2.2.2.2.2.1
    have hg1B := PB.2.2.2.2.2.2.2.2.2.2.1
    have hg4B := PB.2.2.2.2.2.2.2.2.2.2.2.1
    have hg5B := PB.2.2.2.2.2.2.2.2.2.2.2.2.1
    have P := buildsFinal _ stB st1 ptr g0 g2 g3 g4 g5 bytes
      rfl hFit32 hszU hg0_32 hsub40 PB.2.1 h0B h2B h3B hg1B hg4B
      hg5B hh0B hh24B
    simpa [h0B, h2B, h3B] using P
