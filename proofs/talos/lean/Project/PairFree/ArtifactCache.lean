...
namespace Project.PairFree.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  types := [{ params := [Wasm.Binary.ValType.i64, Wasm.Binary.ValType.i64, Wasm.Binary.ValType.i64],
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [115, 104, 97, 114, 101, 100, 80, 97, 105, 114, 70, 114, 101, 101, 83, 116, 97, 116,
                                    115],
                          text := "sharedPairFreeStats" },
  ...
  codes := [{ locals := [{ count := 22, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 33,
...
end Project.PairFree.Artifact.Cache
