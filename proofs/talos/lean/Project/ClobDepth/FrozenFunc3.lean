import Project.ClobDepth.FrozenMissingBranch
import Project.ClobDepth.FrozenFoundBranch
...
namespace Project.ClobDepth.Frozen.Func3

open Wasm Project.Common Project.Clob Project.ClobDepth
  Project.ClobDepth.Frozen.Model Project.ClobDepth.Frozen.Properties
  Project.ClobDepth.Frozen.Representation
...
theorem func3_terminates
  ...
  · simp [«module»]
  · change wp «module» Project.ClobDepth.Frozen.func3 _ st
      (Scan.entryFrame owner source price qty) env
    rw [show Project.ClobDepth.Frozen.func3 =
      Project.ClobDepth.Frozen.func3 ++ ([] : Wasm.Program)
      from (List.append_nil _).symm]
...
end Project.ClobDepth.Frozen.Func3
