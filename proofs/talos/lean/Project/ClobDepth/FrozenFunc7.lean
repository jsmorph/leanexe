import Project.ClobDepth.FrozenFunc6
...
namespace Project.ClobDepth.Frozen.Func7
...
open Wasm Project.Common Project.Clob Project.ClobDepth
  ...
  Project.ClobDepth.Frozen.Func6Fold Project.ClobDepth.Frozen.Func6Loop
...
theorem func7_terminates
  ...
  · simp [«module»]
  · change wp «module» Project.ClobDepth.Frozen.func7 _ st
      { params := [.i64 orders],
        locals := [.i64 0, .i64 0, .i64 0, .i64 0, .i64 0, .i64 0,
          .i64 0, .i64 0, .i64 0, .i64 0, .i64 0, .i64 0],
        values := [] } env
    simp only [Project.ClobDepth.Frozen.func7]
...
end Project.ClobDepth.Frozen.Func7
