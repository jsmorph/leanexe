import Project.ClobDepth.FrozenMissingSearch
...
namespace Project.ClobDepth.Frozen.MissingBump
...
theorem missingBumpProg_spec
  ...
  wp_run_with [Entry.missingBumpBranchProg, hParams, hLocals, hValues, hNeed', hResult']
  ...
  wp_run_with [Entry.missingBumpBranchProg, hParams, hLocals, hValues, hNeed', hResult']
  simp only [hg0]
  try wp_run_with [Entry.missingBumpBranchProg, hParams, hLocals, hValues, hNeed', hResult']
  try simp
...
end Project.ClobDepth.Frozen.MissingBump
