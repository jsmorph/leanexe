...
namespace Project.EulerOutwardFlux.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [102, 108, 117, 120, 67, 104, 101, 99, 107, 101, 100, 66, 105, 116, 115],
                          text := "fluxCheckedBits" },
                desc := Wasm.Binary.ExportDesc.func 54 },
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 55 },
              { name := { bytes := [114, 101, 115, 101, 116], text := "reset" },
                desc := Wasm.Binary.ExportDesc.func 56 },
              { name := { bytes := [114, 101, 116, 97, 105, 110], text := "retain" },
                desc := Wasm.Binary.ExportDesc.func 57 },
              { name := { bytes := [114, 101, 108, 101, 97, 115, 101], text := "release" },
                desc := Wasm.Binary.ExportDesc.func 58 },
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 58 },
...
end Project.EulerOutwardFlux.Artifact.Cache
