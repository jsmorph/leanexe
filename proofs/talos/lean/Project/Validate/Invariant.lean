...
def vFrame
    (fuel owner ptr len index lOwner l5 l6 l7 l8 l9 l10 l11 l12 l13 l14 l15
      l16 l17 l18 l19 l20 lNext l21 l22 l23 : UInt64) : Locals :=
  { params := [.i64 fuel, .i64 owner, .i64 ptr, .i64 len, .i64 index],
    locals := [.i64 lOwner, .i64 l5, .i64 l6, .i64 l7, .i64 l8, .i64 l9, .i64 l10, .i64 l11,
      .i64 l12, .i64 l13, .i64 l14, .i64 l15, .i64 l16, .i64 l17, .i64 l18,
      .i64 l19, .i64 l20, .i64 lNext, .i64 l21, .i64 l22, .i64 l23],
    values := [] }
...
def vInv (st0 : Store Unit) (owner ptr : UInt64) (bytes : List UInt8) :
  ...
  fun st s =>
    ...
    ∃ (fuel index l5 l6 l7 l8 l9 l10 l11 l12 l13 l14 l15 l16 l17 l18 l19
      ...
      s = vFrame fuel owner ptr (UInt64.ofNat bytes.length) index 0 l5 l6 l7 l8 l9
        l10 l11 l12 l13 l14 l15 l16 l17 l18 l19 l20 0 l21 l22 l23 ∧
