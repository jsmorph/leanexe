import Project.SharedPair.FrozenCopyExit
...
namespace Project.SharedPair.Frozen.Spec
...
theorem copySuffix_correct
  ...
  simp only [Project.SharedPair.Frozen.func0, List.drop]
  apply wp_block_cons
...
end Project.SharedPair.Frozen.Spec
