...
namespace Project.SharedPair.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [115, 104, 97, 114, 101, 100, 80, 117, 115, 104, 80, 97, 105, 114],
                          text := "sharedPushPair" },
  ...
  codes := [{ locals := [{ count := 21, type := Wasm.Binary.ValType.i64 }],
...
end Project.SharedPair.Artifact.Cache
