...
namespace Project.PushSize.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [112, 117, 115, 104, 66, 97, 110, 103, 83, 105, 122, 101], text := "pushBangSize" },
  ...
  codes := [{ locals := [{ count := 17, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 33,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 13]
                         none,
                            ...
                            [Wasm.Binary.Instr.localGet 15,
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               [Wasm.Binary.Instr.localGet 14,
                                ...
                                Wasm.Binary.Instr.iff
                                  (Wasm.Binary.BlockType.empty)
                                  [Wasm.Binary.Instr.localGet 17, Wasm.Binary.Instr.globalSet 1]
...
end Project.PushSize.Artifact.Cache
