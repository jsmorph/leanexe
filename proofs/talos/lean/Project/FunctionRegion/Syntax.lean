...
mutual
  inductive PortableInstruction (domain : Nat → Prop) : Instruction → Prop
    ...
    | f64Div : PortableInstruction domain .f64Div
    | f64Sqrt : PortableInstruction domain .f64Sqrt
    ...
    | ret : PortableInstruction domain .ret
...
macro "prove_portable" : tactic => `(tactic|
  repeat' (first
    ...
    | apply PortableInstruction.f64Div
    | apply PortableInstruction.f64Sqrt
