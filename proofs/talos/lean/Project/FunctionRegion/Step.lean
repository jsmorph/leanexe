...
theorem execOne_succ
  ...
  | f32ReinterpretI32 => simp only [renameInstruction, execOne.eq_def]
  | i32ReinterpretF32 => simp only [renameInstruction, execOne.eq_def]
  | f32Add => simp only [renameInstruction, execOne.eq_def]
  | f32Sub => simp only [renameInstruction, execOne.eq_def]
  | f32Mul => simp only [renameInstruction, execOne.eq_def]
  | f32Div => simp only [renameInstruction, execOne.eq_def]
  | f32Sqrt => simp only [renameInstruction, execOne.eq_def]
  | f32Nearest => simp only [renameInstruction, execOne.eq_def]
  | i32TruncSatF32S => simp only [renameInstruction, execOne.eq_def]
  | f32ConvertI32S => simp only [renameInstruction, execOne.eq_def]
  | extend8S => simp only [renameInstruction, execOne.eq_def]
  ...
  | f64Sub => simp only [renameInstruction, execOne.eq_def]
  | f64Mul => simp only [renameInstruction, execOne.eq_def]
  | f64Div => simp only [renameInstruction, execOne.eq_def]
  | f64Sqrt => simp only [renameInstruction, execOne.eq_def]
  ...
  | load32 => simp only [renameInstruction, execOne.eq_def]
  | load8U => simp only [renameInstruction, execOne.eq_def]
  | store8 => simp only [renameInstruction, execOne.eq_def]
  | store32 => simp only [renameInstruction, execOne.eq_def]
