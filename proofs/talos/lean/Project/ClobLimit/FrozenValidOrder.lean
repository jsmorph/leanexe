...
/-!
# Order validity in the `limit` artifact

The first seven generated functions implement the same validity subsystem as
the completed `postOnly` artifact.  These theorems prove the scalar side test,
identifier scan, and combined validity result in the `limit` module.
-/

namespace Project.ClobLimit.Frozen.ValidOrder

open Wasm Project.Common Project.Clob Project.ClobLimit
  Project.ClobPostOnly.Frozen.Model Project.ClobPostOnly.Frozen.SearchHelpers

set_option maxHeartbeats 64000000

theorem generated_validity_functions_eq :
    [func0Def, func1Def, func2Def, func3Def, func4Def, func5Def, func6Def] =
      [Project.ClobPostOnly.Frozen.func0Def, Project.ClobPostOnly.Frozen.func1Def,
       Project.ClobPostOnly.Frozen.func2Def, Project.ClobPostOnly.Frozen.func3Def,
       Project.ClobPostOnly.Frozen.func4Def, Project.ClobPostOnly.Frozen.func5Def,
...
end Project.ClobLimit.Frozen.ValidOrder
