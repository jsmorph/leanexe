...
namespace Project.ClobLimit.Frozen.InternalPartialBranch

open Wasm Project.Common Project.Runtime Project.Clob Project.ClobLimit
  Project.ClobLimit.Frozen.InternalPartialBookControl
  Project.ClobLimit.Frozen.InternalPartialBookPrepare
  Project.ClobLimit.Frozen.InternalPartialBookUpdate
  Project.ClobLimit.Frozen.InternalPartialBookCopy
  Project.ClobLimit.Frozen.InternalPartialBookFinish
  Project.ClobLimit.Frozen.InternalPartialTradeBranch
  Project.ClobLimit.Frozen.InternalPartialTradeUpdate
...
theorem partialBranchProg_spec
  ...
  let newOrders := Project.ClobMatchFuel.Frozen.Model.setQtyL os i qty
  ...
  · intro st1 hBookFinal hNewBookFinal hBookOutside hBookPages hBookGlobals
    ...
    have hNewBook32 : newBook.toNat +
      ...
      rw [show newOrders.length = os.length by
        simp [newOrders, Project.ClobMatchFuel.Frozen.Model.setQtyL_length]]
      rw [← hBookNeedNat]
...
end Project.ClobLimit.Frozen.InternalPartialBranch
