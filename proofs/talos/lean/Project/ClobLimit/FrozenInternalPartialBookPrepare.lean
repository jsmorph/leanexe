...
namespace Project.ClobLimit.Frozen.InternalPartialBookPrepare
...
theorem partialBookPrefixProg_spec
  ...
  have hBookGet : base.params[7] = .i64 book := getElem_of_some hBookLocal
...
end Project.ClobLimit.Frozen.InternalPartialBookPrepare
