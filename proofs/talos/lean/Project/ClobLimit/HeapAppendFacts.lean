...
/-! Pure residual append facts, independent of allocator placement and local layouts. -/
namespace Project.ClobLimit.HeapAppendFacts
open Wasm Project.Common Project.Clob Project.ClobMatchFuel.Allocation
  Project.ClobMatchFuel.AllocatorFrame Project.ClobPostOnly.AppendStore
...
#print axioms finish
end Project.ClobLimit.HeapAppendFacts
