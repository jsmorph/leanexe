...
namespace Project.ClobLimit.Frozen.InternalLoopResult
...
theorem of_zero_running (facts : RunningFacts ctx st s data)
  ...
  rw [hFuel] at hSource
  simp only [UInt64.toNat_zero, Project.ClobMatchFuel.Frozen.Model.matchFuelL] at hSource
...
end Project.ClobLimit.Frozen.InternalLoopResult
