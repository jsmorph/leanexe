...
import Project.ClobMatchFuel.FrozenAllocatorFrame
...
namespace Project.ClobLimit.Frozen.InternalPartialBookUpdate
...
open Wasm Project.Common Project.Clob Project.Runtime Project.ClobLimit
  ...
  Project.ClobMatchFuel.Frozen.BookReplaceStore
...
theorem partialBookUpdateProg_spec
    ...
    (hDone : ∀ st1,
      ...
      OwnedOrderArrayAt st1 (g0 + 48) (fixedArrayBytesU os.length 5)
        (Project.ClobMatchFuel.Frozen.Model.setQtyL os i qty) →
...
end Project.ClobLimit.Frozen.InternalPartialBookUpdate
