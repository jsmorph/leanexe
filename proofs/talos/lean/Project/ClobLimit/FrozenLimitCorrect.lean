...
namespace Project.ClobLimit.Frozen.LimitCorrect
...
inductive OutcomeAt (initial final : Store Unit) (book g0 g2 : UInt64)
  ...
  | invalid
      ...
      (hFresh : Project.ClobLimit.Frozen.Allocation.FreshTradeArrayAt final
        (g0 + 48))
...
end Project.ClobLimit.Frozen.LimitCorrect
