...
namespace Project.ClobLimit.Frozen.Invalid

open Wasm Project.Common Project.Clob Project.ClobLimit
  Project.ClobLimit.Frozen.Model Project.ClobLimit.Frozen.ValidOrder
  Project.ClobLimit.Frozen.Allocation Project.ClobPostOnly.Frozen.Model
...
theorem limit_invalid
  ...
  · change wp «module» func21 _ st
    ...
    wp_run
    refine wp_call_tw
      (Project.ClobLimit.Frozen.ValidOrder.func6_spec env st ptr os order hlen
        hInput) ?_
    ...
    wp_run
    refine wp_call_tw
      (Project.ClobLimit.Frozen.Allocation.func20_spec env st1) ?_
...
end Project.ClobLimit.Frozen.Invalid
