...
namespace Project.ClobLimit.Frozen.LimitValidEntry

open Wasm Project.Clob Project.ClobLimit Project.ClobPostOnly.Frozen.Model
...
end Project.ClobLimit.Frozen.LimitValidEntry
