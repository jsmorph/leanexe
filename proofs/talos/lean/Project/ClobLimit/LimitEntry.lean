...
def validResultStoreProg : Wasm.Program :=
  [.localSet 25, .localSet 24, .localSet 23, .localSet 22, .localSet 21,
   .localGet 21, .localSet 26, .localGet 22, .localSet 27,
   .localGet 23, .localSet 28, .localGet 24, .localSet 29,
   .localGet 25, .localSet 30]
...
def resultProg : Wasm.Program := [.localGet 37, .localGet 39, .localGet 41]
...
def residualResultProg : Wasm.Program :=
  [.localGet 46, .localSet 38, .localGet 38, .localSet 39, .localGet 28, .localSet 40,
   .localGet 29, .localSet 41]
