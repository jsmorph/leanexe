...
namespace Project.ClobLimit.Frozen.InternalFullTradeUpdate

open Wasm Project.Common Project.Clob Project.ClobLimit
  Project.ClobMatchFuel.Frozen.AllocatorFrame
  Project.ClobLimit.Frozen.InternalFullTradePrepare
  Project.ClobLimit.Frozen.InternalFullTradeFinish
  Project.ClobLimit.Frozen.InternalPartialTradeUpdate
  Project.ClobLimit.Frozen.InternalPartialTradeCopy
  Project.ClobLimit.Frozen.InternalPartialTradeFinish
...
theorem fullTradeUpdateProg_spec
  ...
  let trade := Project.ClobMatchFuel.Frozen.Model.fillTradeL
    taker oldOrders[i]! oldOrders[i]!.oqty
  ...
  · simp [fullTradePrepareFrame, trade,
      Project.ClobMatchFuel.Frozen.Model.fillTradeL, hLocals]
  · simp [fullTradePrepareFrame, trade,
      Project.ClobMatchFuel.Frozen.Model.fillTradeL, hLocals]
  · simp [fullTradePrepareFrame, trade,
      Project.ClobMatchFuel.Frozen.Model.fillTradeL, hLocals]
...
end Project.ClobLimit.Frozen.InternalFullTradeUpdate
