...
def func0Def : Wasm.Function :=
  { params := [], locals := [.i64], body := func0, results := [.i64] }
...
def func2Def : Wasm.Function :=
  { params := [], locals := [.i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64], body := func2, results := [.i64] }
