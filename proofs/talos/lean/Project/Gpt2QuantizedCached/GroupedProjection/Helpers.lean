import Project.Gpt2QuantizedCached.ProjectionRegion
...
namespace Project.Gpt2QuantizedCached.GroupedProjection
abbrev «module» := Project.Gpt2QuantizedCached.«module»
abbrev func8 := Project.Gpt2QuantizedCached.func42
abbrev func8Def := Project.Gpt2QuantizedCached.func42Def
export Project.Gpt2QuantizedGroupedRows (partialValue sumPrefix sumPrefix_zero sumPrefix_succ value
  linearGroupedRows_eq grouped_values_size grouped_scales_size linearGroupedRows_size)
...
theorem rescale_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env «module» 40 initial
...
end Project.Gpt2QuantizedCached.GroupedProjection
