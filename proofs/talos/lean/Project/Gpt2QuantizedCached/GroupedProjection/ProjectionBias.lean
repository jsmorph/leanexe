...
def biasCode : Wasm.Program := (branch true).drop 16
...
theorem biasCode_spec (env : HostEnv Unit) (initial : Store Unit)
  ...
  simp only [biasCode, branch, outputWord, outputBody, func8, Project.Gpt2QuantizedCached.func42, List.getElem?_cons_zero,
  ...
  refine PackedWordAccess.guard_spec «module» env initial _ weightsPtr weights
    (biasOffset + index % outputWidth * 4) 97 98 99
