import Project.Gpt2QuantizedCached.GroupedProjection.ProjectionRescale
...
theorem finishGroup_spec (env : HostEnv Unit) (initial : Store Unit)
  ...
  cases withBias <;>
    simp only [finishGroup, groupStep, groupBody, branch, outputWord, outputBody, func8, Project.Gpt2QuantizedCached.func42,
