...
theorem dotPrefix_spec (env : HostEnv Unit) (initial : Store Unit)
  ...
  cases withBias <;>
    simp only [dotPrefix, groupStep, groupBody, branch, outputWord, outputBody, func8, Project.Gpt2QuantizedCached.func42,
  ...
  all_goals
    ...
    have hDot := Project.Gpt2QuantizedCached.GroupedProjection.dot_exact env initial weightsOwner weightsPtr valuePtr valuePtr
