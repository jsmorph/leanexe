...
theorem code0_decoded :
    code { bytes := artifactBytes, pos := 785, limit := 28315 } = .ok (Cache.raw.codes[0]!, { bytes := artifactBytes, pos := 796, limit := 28315 }) := by
  refine code_eq_of_parts (size := 10)
    (payload := { bytes := artifactBytes, pos := 786, limit := 28315 })
