...
theorem code5_decoded :
    code { bytes := artifactBytes, pos := 1060, limit := 28315 } = .ok (Cache.raw.codes[5]!, { bytes := artifactBytes, pos := 1107, limit := 28315 }) := by
  refine code_eq_of_parts (size := 46)
    (payload := { bytes := artifactBytes, pos := 1061, limit := 28315 })
