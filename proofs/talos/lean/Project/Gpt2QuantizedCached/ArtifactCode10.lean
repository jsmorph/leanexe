...
theorem code10_decoded :
    code { bytes := artifactBytes, pos := 1389, limit := 28315 } = .ok (Cache.raw.codes[10]!, { bytes := artifactBytes, pos := 1459, limit := 28315 }) := by
  refine code_eq_of_parts (size := 69)
    (payload := { bytes := artifactBytes, pos := 1390, limit := 28315 })
