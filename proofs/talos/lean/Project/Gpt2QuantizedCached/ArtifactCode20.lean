...
theorem code20_decoded :
    code { bytes := artifactBytes, pos := 2091, limit := 28315 } = .ok (Cache.raw.codes[20]!, { bytes := artifactBytes, pos := 2160, limit := 28315 }) := by
  refine code_eq_of_parts (size := 68)
    (payload := { bytes := artifactBytes, pos := 2092, limit := 28315 })
