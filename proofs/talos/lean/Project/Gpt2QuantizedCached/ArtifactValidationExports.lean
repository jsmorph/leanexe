...
theorem validation_export11 :
    Validator.validateExportEntry Cache.raw Cache.raw.exports[11]! = .ok () := by
  have hname : Cache.raw.exports[11]!.name.text.toByteArray.data.toList =
      Cache.raw.exports[11]!.name.bytes := by rfl
  simp only [Validator.validateExportEntry, hname, ite_true]
  cbv
...
theorem validation_exports : Validator.validateExports Cache.raw = .ok () := by
  ...
  change Validator.validateExportEntries Cache.raw
    [Cache.raw.exports[0]!, Cache.raw.exports[1]!, Cache.raw.exports[2]!, Cache.raw.exports[3]!, Cache.raw.exports[4]!, Cache.raw.exports[5]!, Cache.raw.exports[6]!, Cache.raw.exports[7]!, Cache.raw.exports[8]!, Cache.raw.exports[9]!, Cache.raw.exports[10]!, Cache.raw.exports[11]!] = .ok ()
  simp only [Validator.validateExportEntries, Bind.bind, Pure.pure, Except.pure, Except.bind, validation_export0, validation_export1, validation_export2, validation_export3, validation_export4, validation_export5, validation_export6, validation_export7, validation_export8, validation_export9, validation_export10, validation_export11]
