...
theorem emitted_finishTail : func58.drop 108 =
    finishUpdatesReleaseCode ++ finishAliasReleaseCode ++ finishEmbeddingReleaseCode ++
    [.localGet 120, .localGet 121, .localGet 122, .localGet 123, .localGet 124, .localGet 125, .localGet 126] := rfl
...
theorem finishTail_spec (env : HostEnv Unit) (original initial : Store Unit) (before heap : Heap)
    ...
    wp «module» (func58.drop 108) Q initial frame env := by
