...
def finishUpdatesReleaseCode : Program :=
  PackedReleaseFilter.program 100 [13, 121, 124] [.localGet 100, .call 65]

def finishAliasReleaseCode : Program :=
  PackedReleaseFilter.program 101 [100, 13, 121, 124] [.localGet 101, .call 65]

def finishEmbeddingReleaseCode : Program :=
  PackedReleaseFilter.program 13 [121, 124] [.localGet 13, .call 65]

set_option maxRecDepth 32768 in
theorem emitted_finishRelease : (func58.drop 108).take 24 =
    finishUpdatesReleaseCode ++ finishAliasReleaseCode ++ finishEmbeddingReleaseCode := rfl
