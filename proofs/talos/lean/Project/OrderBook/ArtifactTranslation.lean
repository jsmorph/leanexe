import Project.OrderBook.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.OrderBook.func0Def, Project.OrderBook.func1Def, Project.OrderBook.func2Def, Project.OrderBook.func3Def, Project.OrderBook.func4Def, Project.OrderBook.func5Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq, function5_eq]

def executionCache : Wasm.Module :=
  Project.OrderBook.«module»
