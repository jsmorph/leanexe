...
namespace Project.AppendBang.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  types := [{ params := [Wasm.Binary.ValType.i64, Wasm.Binary.ValType.i64],
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [97, 112, 112, 101, 110, 100, 66, 97, 110, 103], text := "appendBang" },
...
end Project.AppendBang.Artifact.Cache
