...
theorem scanIndex_spec {env : HostEnv Unit} {st : Store Unit}
    ...
    {e2 e3 e4 e5 e6 g7 g8 g9 g10 g11 g12 g13 g14 g15 g20 g21 g22 g23 g24 g25
     g26 g27 g28 g29 g30 g31 : UInt64}
      ...
      ∀ f2 f3 f4 f5 f6 : UInt64,
        wp «module» rest Q st
          ({ params := [.i64 ptr, .i64 cid],
             ...
             .i64 g13, .i64 g14, .i64 g15, .i64 ptr, .i64 (UInt64.ofNat os.length),
             .i64 (UInt64.ofNat os.length), .i64 0, .i64 g20, .i64 g21,
             .i64 g22, .i64 g23, .i64 g24, .i64 g25, .i64 g26, .i64 g27,
             .i64 g28, .i64 g29, .i64 g30, .i64 g31],
             values := [] } : Locals)
          env)
      ...
      ∀ f2 f3 f4 f5 f6 : UInt64,
        wp «module» rest Q st
          ({ params := [.i64 ptr, .i64 cid],
             ...
             .i64 g7, .i64 g8, .i64 g9, .i64 g10, .i64 g11, .i64 g12,
             .i64 g13, .i64 g14, .i64 g15, .i64 ptr, .i64 (UInt64.ofNat os.length),
             .i64 (UInt64.ofNat i), .i64 (UInt64.ofNat i + 1), .i64 g20,
             .i64 g21, .i64 g22, .i64 g23, .i64 g24, .i64 g25, .i64 g26,
             .i64 g27, .i64 g28, .i64 g29, .i64 g30, .i64 g31],
             values := [] } : Locals)
          env) :
    wp «module»
      (  .block 0 0 [
    .loop 0 0 [
      ...
      ({ params := [.i64 ptr, .i64 cid],
         ...
         .i64 g7, .i64 g8, .i64 g9, .i64 g10, .i64 g11, .i64 g12,
         .i64 g13, .i64 g14, .i64 g15, .i64 ptr, .i64 (UInt64.ofNat os.length),
         .i64 0, .i64 0, .i64 g20, .i64 g21, .i64 g22, .i64 g23, .i64 g24,
         .i64 g25, .i64 g26, .i64 g27, .i64 g28, .i64 g29, .i64 g30,
         .i64 g31],
         values := [] } : Locals)
      env := by
  obtain ⟨-, hElems⟩ := hIn
    ...
    (Inv := fun st' s =>
      ...
      ∃ f2 f3 f4 f5 f6 : UInt64,
        s = ({ params := [.i64 ptr, .i64 cid],
               ...
               .i64 g7, .i64 g8, .i64 g9, .i64 g10, .i64 g11, .i64 g12,
               .i64 g13, .i64 g14, .i64 g15, .i64 ptr, .i64 (UInt64.ofNat os.length),
               .i64 (UInt64.ofNat k), .i64 0, .i64 g20, .i64 g21, .i64 g22,
               .i64 g23, .i64 g24, .i64 g25, .i64 g26, .i64 g27, .i64 g28,
               .i64 g29, .i64 g30, .i64 g31],
               values := [] } : Locals))
    (μ := fun _ s =>
      match s.locals with
