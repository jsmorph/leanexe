...
import Project.EulerGridStep.FrozenMixedWriterProtected
...
theorem advanceAt_mixed_protected {m : Wasm.Module} (layout : Layout m)
  ...
  have hWriter := writeCell_mixed_protected layout env initial unused heapTop allocs releases frees
...
#print axioms advanceAt_mixed_protected
