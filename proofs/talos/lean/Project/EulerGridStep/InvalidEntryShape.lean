...
def invalidEntryAllocationRegion : Wasm.Program :=
  [.constI64 0, .localSet 51, .constI64 0, .localSet 47, .globalGet 1, .localSet 48] ++
    search 37 1 ++ [.localGet 51, .constI64 0, .eqI64, .iff 0 0 invalidEntryBumpBody []] ++
    [.globalGet 2, .constI64 1, .addI64, .globalSet 2, .localGet 51, .localSet 42]

theorem invalid_entry_capacity_shape : gridInvalidBody.take 18 =
    FixedArrayCapacity.constantProgram 1 1 46 := rfl
...
theorem invalid_entry_bump_header_shape : invalidEntryBumpBody =
    invalidEntryBumpBody.take 28 ++ allocationHeaderProgram 51 46 := rfl
