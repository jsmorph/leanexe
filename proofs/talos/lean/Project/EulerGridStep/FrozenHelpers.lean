...
import Project.EulerGridStep.FrozenOutputs
...
theorem cellLayout : Project.EulerCellStep.Execution.Layout Project.EulerGridStep.Frozen.«module» := by
...
theorem concreteLayout : Layout Project.EulerGridStep.Frozen.«module» := by
