...
import Project.EulerGridStep.ReusedWriterProtected
...
theorem advanceAt_reused_protected {m : Wasm.Module} (layout : Layout m)
    ...
    (hState : ReusedCellState initial heapTop roots output index (Model.cellAt ratio input index)
  ...
  have hWriter := writeCell_reused_protected layout env initial unused heapTop allocs releases frees
