...
namespace Project.EulerGridStep.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [115, 116, 101, 112, 67, 104, 101, 99, 107, 101, 100, 66, 105, 116, 115],
                          text := "stepCheckedBits" },
                desc := Wasm.Binary.ExportDesc.func 36 },
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 37 },
              ...
              { name := { bytes := [114, 101, 116, 97, 105, 110], text := "retain" },
                desc := Wasm.Binary.ExportDesc.func 39 },
              { name := { bytes := [114, 101, 108, 101, 97, 115, 101], text := "release" },
                desc := Wasm.Binary.ExportDesc.func 40 },
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 40 },
  ...
  codes := [{ locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
            ...
            { locals := [{ count := 5, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 0,
                       ...
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.value (Wasm.Binary.ValType.i32))
                         [Wasm.Binary.Instr.localGet 0, Wasm.Binary.Instr.localGet 2, Wasm.Binary.Instr.i64LeU]
                         (some [Wasm.Binary.Instr.i32Const 0]),
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.value (Wasm.Binary.ValType.i64))
                         [Wasm.Binary.Instr.i64Const 1]
            ...
            { locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 3, Wasm.Binary.Instr.localSet 7, Wasm.Binary.Instr.localGet 7] },
            { locals := [{ count := 2, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 1,
                       Wasm.Binary.Instr.localSet 0,
                       Wasm.Binary.Instr.i64Const 0,
            ...
            { locals := [{ count := 23, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 0,
                       ...
                       Wasm.Binary.Instr.localGet 27] },
            { locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 4, Wasm.Binary.Instr.localSet 7, Wasm.Binary.Instr.localGet 7] },
            { locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
            ...
            { locals := [{ count := 5, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 1,
                       ...
                       Wasm.Binary.Instr.localGet 3,
                       Wasm.Binary.Instr.localGet 4] },
            { locals := [{ count := 82, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 0,
                       Wasm.Binary.Instr.localSet 6,
                       Wasm.Binary.Instr.localGet 1,
                       Wasm.Binary.Instr.localSet 7,
                          ...
                          Wasm.Binary.Instr.iff
                            ...
                            [Wasm.Binary.Instr.localGet 19,
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               (some [Wasm.Binary.Instr.call 15,
            ...
            { locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 2, Wasm.Binary.Instr.localSet 7, Wasm.Binary.Instr.localGet 7] },
            { locals := [{ count := 7, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 1,
                       Wasm.Binary.Instr.localSet 0,
                       Wasm.Binary.Instr.i64Const 0,
                       ...
                       Wasm.Binary.Instr.localGet 5,
                       Wasm.Binary.Instr.localGet 6] },
            { locals := [{ count := 127, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 0,
                       Wasm.Binary.Instr.localSet 10,
                       Wasm.Binary.Instr.localGet 10,
                       Wasm.Binary.Instr.call 0,
                                   ...
                                   Wasm.Binary.Instr.iff
                                     ...
                                     [Wasm.Binary.Instr.localGet 54,
                                      ...
                                      Wasm.Binary.Instr.iff
                                        ...
                                        (some [Wasm.Binary.Instr.call 24,
              ...
              body := [Wasm.Binary.Instr.localGet 1,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.localGet 12,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 19]
                            none,
                          Wasm.Binary.Instr.i64Const 0,
                          Wasm.Binary.Instr.localSet 24,
                          Wasm.Binary.Instr.i64Const 0,
                               ...
                               [Wasm.Binary.Instr.localGet 21,
                                ...
                                Wasm.Binary.Instr.iff
                                  ...
                                  [Wasm.Binary.Instr.localGet 20,
                                   ...
                                   Wasm.Binary.Instr.iff
                                     (Wasm.Binary.BlockType.empty)
                                     [Wasm.Binary.Instr.localGet 23, Wasm.Binary.Instr.globalSet 1]
                       ...
                       Wasm.Binary.Instr.localGet 9] },
            { locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 1, Wasm.Binary.Instr.localSet 7, Wasm.Binary.Instr.localGet 7] },
            { locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 2, Wasm.Binary.Instr.localSet 7, Wasm.Binary.Instr.localGet 7] },
            { locals := [{ count := 1, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 3, Wasm.Binary.Instr.localSet 7, Wasm.Binary.Instr.localGet 7] },
              ...
              body := [Wasm.Binary.Instr.localGet 3,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.localGet 0,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.localGet 51, Wasm.Binary.Instr.call 40]
                            (some []),
                          Wasm.Binary.Instr.localGet 42,
                          Wasm.Binary.Instr.i64Const 0,
                          Wasm.Binary.Instr.i64Eq,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.localGet 42, Wasm.Binary.Instr.call 40]
                            (some []),
                          Wasm.Binary.Instr.localGet 33,
                          Wasm.Binary.Instr.i64Const 0,
                          Wasm.Binary.Instr.i64Eq,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.localGet 33, Wasm.Binary.Instr.call 40]
                            (some []),
                          Wasm.Binary.Instr.localGet 24,
                          Wasm.Binary.Instr.i64Const 0,
                          Wasm.Binary.Instr.i64Eq,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.localGet 24, Wasm.Binary.Instr.call 40]
                            (some []),
                          Wasm.Binary.Instr.localGet 15,
                          Wasm.Binary.Instr.i64Const 0,
                          Wasm.Binary.Instr.i64Eq,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.localGet 15, Wasm.Binary.Instr.call 40]
                            (some [])]
                         (some [Wasm.Binary.Instr.localGet 1,
                           ...
                           Wasm.Binary.Instr.iff
                             ...
                             [Wasm.Binary.Instr.localGet 69,
                              ...
                              Wasm.Binary.Instr.iff
                                (Wasm.Binary.BlockType.empty)
                                [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 76]
                                none,
                              Wasm.Binary.Instr.i64Const 0,
                              Wasm.Binary.Instr.localSet 81,
                              Wasm.Binary.Instr.i64Const 0,
                                   ...
                                   [Wasm.Binary.Instr.localGet 78,
                                    ...
                                    Wasm.Binary.Instr.iff
                                      ...
                                      [Wasm.Binary.Instr.localGet 77,
                                       ...
                                       Wasm.Binary.Instr.iff
                                         (Wasm.Binary.BlockType.empty)
                                         [Wasm.Binary.Instr.localGet 80, Wasm.Binary.Instr.globalSet 1]
            ...
            { locals := [{ count := 62, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 3,
                       Wasm.Binary.Instr.localSet 65,
                       Wasm.Binary.Instr.localGet 5,
                       Wasm.Binary.Instr.localSet 66,
                       Wasm.Binary.Instr.localGet 66,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         (some [Wasm.Binary.Instr.i64Const (-1),
                           ...
                           Wasm.Binary.Instr.iff
                             (Wasm.Binary.BlockType.value (Wasm.Binary.ValType.i64))
                             [Wasm.Binary.Instr.unreachable]
                             (some [Wasm.Binary.Instr.localGet 65,
                               Wasm.Binary.Instr.localGet 66,
                               Wasm.Binary.Instr.i64Mul])]),
                       Wasm.Binary.Instr.localSet 6,
                       Wasm.Binary.Instr.localGet 5,
              ...
              body := [Wasm.Binary.Instr.localGet 0,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.i64Const 8,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 37]
                            none,
                          Wasm.Binary.Instr.i64Const 0,
                          Wasm.Binary.Instr.localSet 42,
                          Wasm.Binary.Instr.i64Const 0,
                               ...
                               [Wasm.Binary.Instr.localGet 39,
                                ...
                                Wasm.Binary.Instr.iff
                                  ...
                                  [Wasm.Binary.Instr.localGet 38,
                                   ...
                                   Wasm.Binary.Instr.iff
                                     (Wasm.Binary.BlockType.empty)
                                     [Wasm.Binary.Instr.localGet 41, Wasm.Binary.Instr.globalSet 1]
                         ...
                         (some [Wasm.Binary.Instr.localGet 1,
                           ...
                           Wasm.Binary.Instr.iff
                             (Wasm.Binary.BlockType.empty)
                             [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 39]
                             none,
                           Wasm.Binary.Instr.i64Const 0,
                           Wasm.Binary.Instr.localSet 44,
                           Wasm.Binary.Instr.i64Const 0,
                                ...
                                [Wasm.Binary.Instr.localGet 41,
                                 ...
                                 Wasm.Binary.Instr.iff
                                   ...
                                   [Wasm.Binary.Instr.localGet 40,
                                    ...
                                    Wasm.Binary.Instr.iff
                                      (Wasm.Binary.BlockType.empty)
                                      [Wasm.Binary.Instr.localGet 43, Wasm.Binary.Instr.globalSet 1]
                           ...
                           Wasm.Binary.Instr.iff
                             (Wasm.Binary.BlockType.empty)
                             [Wasm.Binary.Instr.localGet 7, Wasm.Binary.Instr.call 40]
                             (some [])]),
                       Wasm.Binary.Instr.localGet 32] },
...
end Project.EulerGridStep.Artifact.Cache
