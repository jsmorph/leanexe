import Project.EulerGridStep.FrozenAdvanceMixed
...
theorem advanceAt_later_arena {m : Wasm.Module} (layout : Layout m)
  ...
  have hCall := advanceAt_mixed_accepted layout env initial ratio inputUnused pointer unused
  ...
  apply hCall.mono
  rintro final values ⟨hValues, hBuffers, hHeap, hPages, hInputFinal⟩
  ...
  refine ⟨?_, ⟨?_, ?_, ?_⟩, hPages, hInputFinal⟩
...
#print axioms advanceAt_later_arena
