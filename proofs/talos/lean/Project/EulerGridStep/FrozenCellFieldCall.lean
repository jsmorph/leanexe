import Project.EulerGridStep.FrozenCellPrefixes

namespace Project.EulerGridStep.Frozen.Execution
open Wasm
open Project.ProofKit

/-- One of the six exact field calls advances the cell's live-buffer prefix. -/
theorem cell_field_call {m : Wasm.Module} (layout : Layout m)
  ...
  exact ⟨hValues, by simpa only [cellPrefix_size, cellLive, cellPrefix] using hFinal⟩

#print axioms cell_field_call
