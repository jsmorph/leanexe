...
def initialAllocationRegion : Wasm.Program :=
  [.constI64 0, .localSet 53, .constI64 0, .localSet 49, .globalGet 1, .localSet 50] ++
    search 39 1 ++ [.localGet 53, .constI64 0, .eqI64, .iff 0 0 initialBumpBody []] ++
    [.globalGet 2, .constI64 1, .addI64, .globalSet 2, .localGet 53, .localSet 43]

def initialZeroBody : Wasm.Program :=
  [.localGet 44, .localGet 42, .geUI64, .br_if 1,
    .localGet 43, .localGet 44, .constI64 1, .mulI64, .constI64 1, .addI64,
    .constI64 8, .mulI64, .addI64, .wrapI64, .localGet 45, .store64 0,
    .localGet 44, .constI64 1, .addI64, .localSet 44, .br 0]

def initialZeroLoop : Wasm.Program := [.block 0 0 [.loop 0 0 initialZeroBody]]

theorem grid_function_shape : func36 = func36.take 17 ++
    [.iff 0 0 gridInvalidBody gridValidBody, .localGet 41] := rfl
...
theorem initial_bump_header_shape : initialBumpBody =
    initialBumpBody.take 28 ++ allocationHeaderProgram 53 48 := rfl

theorem initial_zero_shape : (gridValidBody.drop 71).take 7 =
    [.localGet 43, .wrapI64, .localGet 42, .store64 0, .constI64 0, .localSet 44] ++ initialZeroLoop := rfl

theorem grid_frame_shape : func36Def.params.length = 2 ∧ func36Def.locals.length = 52 := ⟨rfl, rfl⟩
