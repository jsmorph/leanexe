import Project.EulerGridStep.FrozenGridExecution
import Project.EulerGridStep.FrozenGridReset

namespace Project.EulerGridStep.Frozen.Spec
open Wasm
open Project.EulerGridStep.Frozen.Execution
...
theorem stepCheckedBits_exact : ExactSpecFor Project.EulerGridStep.Frozen.«module» := by
...
theorem stepCheckedBits_wat_safe : SafeSpecFor Project.EulerGridStep.Frozen.«module» := by
  intro env initial ratio pointer allocs releases frees base input hReady
...
theorem reset_exact : ResetSpecFor Project.EulerGridStep.Frozen.«module» := by
...
end Project.EulerGridStep.Frozen.Spec
