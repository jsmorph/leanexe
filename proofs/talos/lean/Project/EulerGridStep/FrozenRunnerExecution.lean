import Project.EulerGridStep.FrozenRunner

namespace Project.EulerGridStep.Frozen.Runner
open Wasm
...
theorem runner_wat_exact_safe : RunnerSpecFor Project.EulerGridStep.Frozen.«module» := by
...
theorem sod100_wat_exact_safe (env : HostEnv Unit) (ratios : List UInt64)
    ...
    WasmTrace Project.EulerGridStep.Frozen.«module» env 100 sod100 ratios outputs :=
...
end Project.EulerGridStep.Frozen.Runner
