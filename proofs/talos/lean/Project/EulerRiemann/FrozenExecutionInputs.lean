...
theorem orient_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 39 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func39 _ initial
...
theorem cellInputs_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 40 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func40 _ initial
