import Project.EulerRiemann.ArtifactCodeVector
import Project.EulerRiemann.ArtifactTypeSection
import Project.EulerRiemann.ArtifactSimpleSections
import Project.EulerRiemann.ArtifactExportSection
...
theorem sections_from6 :
    sectionLoop 21753 6 Cache.raw { bytes := artifactBytes, pos := 21767, limit := 21767 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 21767, limit := 21767 }) := by rfl
