import Project.EulerRiemann.FrozenRetryLoop
...
theorem retry_exact_of_success (env : HostEnv Unit) (initial : Store Unit) (heap : Heap)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 81 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func81 _ initial entry env
