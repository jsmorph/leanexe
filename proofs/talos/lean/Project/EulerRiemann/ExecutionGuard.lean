import Project.EulerRiemann.ExecutionGuardMomentum
...
theorem energy_guard_exact (env : HostEnv Unit) (initial : Store Unit) (rho mx my energy : UInt64) :
    TerminatesWith env Project.EulerRiemann.«module» 19 initial
  ...
  change wp Project.EulerRiemann.«module» func19 _ initial
...
theorem state_guard_exact (env : HostEnv Unit) (initial : Store Unit) (rho mx my energy : UInt64) :
    TerminatesWith env Project.EulerRiemann.«module» 20 initial
      [.i64 energy, .i64 my, .i64 mx, .i64 rho]
      (fun final values => final = initial ∧
  ...
  change wp Project.EulerRiemann.«module» func20 _ initial
