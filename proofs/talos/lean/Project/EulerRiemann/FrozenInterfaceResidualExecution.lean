import Project.EulerRiemann.FrozenNumericsInterfaceResidual
import Project.EulerRiemann.FrozenExecutionFlux

namespace Project.EulerRiemann.Frozen.InterfaceResidual
...
theorem interface_residual : SpecFor Project.EulerRiemann.Frozen.module := by
...
end Project.EulerRiemann.Frozen.InterfaceResidual
