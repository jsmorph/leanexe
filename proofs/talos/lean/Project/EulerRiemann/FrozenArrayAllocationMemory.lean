...
open Wasm Project.Runtime Project.Clob Project.ClobMatchFuel.Frozen.BookAllocFit Project.ProofKit
...
theorem arrayAllocated_freeList (store : Store Unit) (base need stride : UInt64) (nodes : List FreeNode)
  ...
  | some choice =>
    simpa only [FixedArrayAllocate.allocated, allocatedNodes, hTake,
      Project.ClobMatchFuel.BookAllocFit.fixedArrayAllocFitStore] using
      Project.ClobMatchFuel.BookAllocFit.freeListAt_fixedArrayAllocFitMem stride hList hTake
  | none =>
...
theorem arrayAllocated_fresh (store : Store Unit) (base need stride : UInt64) (nodes : List FreeNode)
  ...
  | some choice =>
    simpa only [FixedArrayAllocate.allocated, allocatedRoot, allocatedCapacity, hTake] using
      Project.ClobMatchFuel.BookAllocFit.freshFixedArrayAt_fixedArrayAllocFitStore stride hList hTake
  | none =>
