import Project.EulerRiemann.FrozenScanLoop
...
theorem scan_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 32 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func32 _ initial
    (func32Def.toLocals [.i64 owner, .i64 pointer]) env
  rw [scan_shape]
  unfold scanHead func32
  dsimp only
  wp_run [func32Def, List.set, List.getElem?_cons_zero, List.getElem?_cons_succ,
