import Project.EulerRiemann.FrozenAdvanceTotalIteration
...
theorem advance_total_loop_spec (env : HostEnv Unit) (initial : Store Unit) (initialHeap : Heap)
  ...
  · intro current currentFrame hCurrent
    exact advance_total_iteration_spec env initial initialHeap n startTime expected spare limit pageLimit
