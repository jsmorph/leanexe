...
import Project.EulerRiemann.FrozenExecutionNeighbor
...
theorem endTime_exact (env : HostEnv Unit) (initial : Store Unit) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 0 initial []
  ...
  change wp Project.EulerRiemann.Frozen.«module» func0 _ initial (func0Def.toLocals []) env
...
theorem validAdvance_exact (env : HostEnv Unit) (initial : Store Unit) (time dt : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 36 initial [.i64 dt, .i64 time]
  ...
  change wp Project.EulerRiemann.Frozen.«module» func36 _ initial
