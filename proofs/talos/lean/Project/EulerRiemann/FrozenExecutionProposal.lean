import Project.EulerRiemann.FrozenExecutionSpacing
...
theorem proposal_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 35 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func35 _ initial
