...
import Project.EulerRiemann.FrozenInitialModel

namespace Project.EulerRiemann.Frozen.Execution
open Wasm

theorem fifths_exact (env : HostEnv Unit) (initial : Store Unit) (n : Fin 6) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 86 initial [.i64 (UInt64.ofNat n.val)]
  ...
  change wp Project.EulerRiemann.Frozen.«module» func86 _ initial
...
theorem weightedWord_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 87 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func87 _ initial
...
theorem conservative_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 88 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func88 _ initial
