import Project.EulerRiemann.FrozenExecutionInitialStates
...
theorem weighted_tail_spec (env : HostEnv Unit) (initial : Store Unit) (x y : Fin 6)
    ...
    wp Project.EulerRiemann.Frozen.«module» (func93.drop 95) Q initial frame env := by
  unfold func93
  dsimp only
...
theorem weighted_exact (env : HostEnv Unit) (initial : Store Unit) (x y : Fin 6) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 93 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func93 _ initial
