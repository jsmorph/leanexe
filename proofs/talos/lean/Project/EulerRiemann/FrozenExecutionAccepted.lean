import Project.EulerRiemann.FrozenAcceptedLoop
...
theorem accepted_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 79 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func79 _ initial
