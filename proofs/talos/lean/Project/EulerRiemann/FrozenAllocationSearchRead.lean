import Project.EulerRiemann.FrozenAllocationReuse
...
theorem searchRead_spec (env : HostEnv Unit) (store : Store Unit)
    ...
    wp Project.EulerRiemann.Frozen.«module» (searchRead ++ rest) Q store
...
theorem searchAdvance_spec (env : HostEnv Unit) (store : Store Unit)
    ...
    wp Project.EulerRiemann.Frozen.«module» (searchAdvance ++ rest) Q store
