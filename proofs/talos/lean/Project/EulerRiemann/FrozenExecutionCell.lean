import Project.EulerRiemann.FrozenExecutionFlux
...
theorem positive_exact (env : HostEnv Unit) (initial : Store Unit) (word : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 2 initial [.i64 word]
...
theorem rejectedCell_exact (env : HostEnv Unit) (initial : Store Unit) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 64 initial []
      (fun final values => final = initial ∧
  ...
  change wp Project.EulerRiemann.Frozen.«module» func64 _ initial (func64Def.toLocals []) env
  unfold func64
  wp_run
...
theorem cell_exact
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 65 initial [.i64 energyR, .i64 transverseR, .i64 momentumR, .i64 rhoR, .i64 energy, .i64 transverse, .i64 momentum, .i64 rho, .i64 energyL, .i64 transverseL, .i64 momentumL, .i64 rhoL, .i64 ratio]
  ...
  change TerminatesWith env Project.EulerRiemann.Frozen.«module» 54 initial [.i64 energy, .i64 transverse, .i64 momentum, .i64 rho, .i64 energyL, .i64 transverseL, .i64 momentumL, .i64 rhoL]
  ...
  change TerminatesWith env Project.EulerRiemann.Frozen.«module» 54 initial [.i64 energyR, .i64 transverseR, .i64 momentumR, .i64 rhoR, .i64 energy, .i64 transverse, .i64 momentum, .i64 rho]
  ...
  change TerminatesWith env Project.EulerRiemann.Frozen.«module» 58 initial [.i64 right.mass, .i64 left.mass, .i64 rho, .i64 ratio]
  ...
  change TerminatesWith env Project.EulerRiemann.Frozen.«module» 58 initial [.i64 right.momentum, .i64 left.momentum, .i64 momentum, .i64 ratio]
  ...
  change TerminatesWith env Project.EulerRiemann.Frozen.«module» 58 initial [.i64 right.transverse, .i64 left.transverse, .i64 transverse, .i64 ratio]
  ...
  change TerminatesWith env Project.EulerRiemann.Frozen.«module» 58 initial [.i64 right.energy, .i64 left.energy, .i64 energy, .i64 ratio]
  ...
  change TerminatesWith env Project.EulerRiemann.Frozen.«module» 22 initial [.i64 nextEnergy.value, .i64 nextTransverse.value, .i64 nextMomentum.value, .i64 nextDensity.value]
  ...
  refine TerminatesWith.of_wp_entry_for (f := func65Def)
    rfl ?_ (by decide)
  change wp Project.EulerRiemann.Frozen.«module» func65 _ initial (func65Def.toLocals [.i64 ratio, .i64 rhoL, .i64 momentumL, .i64 transverseL, .i64 energyL, .i64 rho, .i64 momentum, .i64 transverse, .i64 energy, .i64 rhoR, .i64 momentumR, .i64 transverseR, .i64 energyR]) env
  unfold func65
