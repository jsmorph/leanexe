import Project.EulerRiemann.FrozenInitialCoordinateMul
...
theorem initial_coordinate_spec (remainder : Bool) (env : HostEnv Unit)
    ...
    wp Project.EulerRiemann.Frozen.«module» (initialCoordinateProgram remainder ++ rest)
  ...
  have hDiv : wp Project.EulerRiemann.Frozen.«module»
