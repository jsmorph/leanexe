...
theorem componentShift :
    Shift Project.EulerDynamicFlux.«module» Project.EulerRiemann.Frozen.«module»
...
theorem component_core_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 45 initial
...
theorem component_exact (env : HostEnv Unit) (initial : Store Unit)
    (alpha fluxL fluxR stateL stateR : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 46 initial
      [.i64 stateR, .i64 stateL, .i64 fluxR, .i64 fluxL, .i64 alpha]
      (fun final values => final = initial ∧
  ...
  change wp Project.EulerRiemann.Frozen.«module» func46 _ initial
...
theorem updateShift :
    Shift Project.EulerCellStep.«module» Project.EulerRiemann.Frozen.«module»
...
theorem update_core_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 57 initial
...
theorem update_exact (env : HostEnv Unit) (initial : Store Unit)
    (ratio state fluxL fluxR : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 58 initial
      [.i64 fluxR, .i64 fluxL, .i64 state, .i64 ratio]
      (fun final values => final = initial ∧
  ...
  change wp Project.EulerRiemann.Frozen.«module» func58 _ initial
