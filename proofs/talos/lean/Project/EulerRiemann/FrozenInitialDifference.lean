import Project.EulerRiemann.FrozenInitialCoordinate
...
theorem initial_difference_spec (remainder : Bool) (env : HostEnv Unit)
    ...
    wp Project.EulerRiemann.Frozen.«module» (initialDifferenceProgram remainder ++ rest)
  ...
  have hSub : wp Project.EulerRiemann.Frozen.«module» (NatSub.program 41 42 ++ rest)
