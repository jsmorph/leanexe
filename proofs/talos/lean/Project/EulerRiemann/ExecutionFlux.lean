...
theorem rejectedFlux_exact (env : HostEnv Unit) (initial : Store Unit) :
    TerminatesWith env Project.EulerRiemann.«module» 53 initial []
      (fun final values => final = initial ∧
        values = [.i64 0, .i64 0, .i64 0, .i64 0, .i64 0, .i64 1]) := by
  refine TerminatesWith.of_wp_entry_for (f := func53Def) rfl ?_ (by decide)
  change wp Project.EulerRiemann.«module» func53 _ initial (func53Def.toLocals []) env
  unfold func53
  wp_run
...
theorem flux_exact
    ...
    TerminatesWith env Project.EulerRiemann.«module» 54 initial [.i64 energyR, .i64 transverseR, .i64 momentumR, .i64 rhoR, .i64 energyL, .i64 transverseL, .i64 momentumL, .i64 rhoL]
  ...
  change TerminatesWith env Project.EulerRiemann.«module» 22 initial [.i64 energyL, .i64 transverseL, .i64 momentumL, .i64 rhoL]
  ...
  change TerminatesWith env Project.EulerRiemann.«module» 22 initial [.i64 energyR, .i64 transverseR, .i64 momentumR, .i64 rhoR]
  ...
  refine TerminatesWith.of_wp_entry_for (f := func54Def)
    rfl ?_ (by decide)
  change wp Project.EulerRiemann.«module» func54 _ initial (func54Def.toLocals [.i64 rhoL, .i64 momentumL, .i64 transverseL, .i64 energyL, .i64 rhoR, .i64 momentumR, .i64 transverseR, .i64 energyR]) env
  unfold func54
  ...
  all_goals
    ...
    change TerminatesWith env Project.EulerRiemann.«module» 46 initial [.i64 rhoR, .i64 rhoL, .i64 right.massFlux, .i64 left.massFlux, .i64 alpha]
    ...
    change TerminatesWith env Project.EulerRiemann.«module» 46 initial [.i64 momentumR, .i64 momentumL, .i64 right.momentumFlux, .i64 left.momentumFlux, .i64 alpha]
    ...
    change TerminatesWith env Project.EulerRiemann.«module» 46 initial [.i64 transverseR, .i64 transverseL, .i64 right.transverseFlux, .i64 left.transverseFlux, .i64 alpha]
    ...
    change TerminatesWith env Project.EulerRiemann.«module» 46 initial [.i64 energyR, .i64 energyL, .i64 right.energyFlux, .i64 left.energyFlux, .i64 alpha]
