...
theorem side_exact
    ...
    TerminatesWith env Project.EulerRiemann.«module» 22 initial [.i64 energy, .i64 transverse, .i64 momentum, .i64 rho]
  ...
  refine TerminatesWith.of_wp_entry_for (f := func22Def)
    rfl ?_ (by decide)
  change wp Project.EulerRiemann.«module» func22 _ initial (func22Def.toLocals [.i64 rho, .i64 momentum, .i64 transverse, .i64 energy]) env
  unfold func22
