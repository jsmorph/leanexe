...
theorem smallNaturalBits_exact (env : HostEnv Unit) (initial : Store Unit)
    (n : Nat) (hn : n ≤ 800) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 33 initial [.i64 (UInt64.ofNat n)]
  ...
  change wp Project.EulerRiemann.Frozen.«module» func33 _ initial
...
theorem spacing_exact (env : HostEnv Unit) (initial : Store Unit)
    (n : Nat) (hn : n ≤ 800) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 34 initial [.i64 (UInt64.ofNat n)]
  ...
  change wp Project.EulerRiemann.Frozen.«module» func34 _ initial
