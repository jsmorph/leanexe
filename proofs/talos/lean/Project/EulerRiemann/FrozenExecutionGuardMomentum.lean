import Project.EulerRiemann.FrozenExecutionGuardBase
...
theorem tiny_exact (env : HostEnv Unit) (initial : Store Unit) (word top : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 13 initial [.i64 top, .i64 word]
  ...
  change wp Project.EulerRiemann.Frozen.«module» func13 _ initial
...
theorem momentum_normalizable_exact (env : HostEnv Unit) (initial : Store Unit) (word top : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 14 initial [.i64 top, .i64 word]
  ...
  change wp Project.EulerRiemann.Frozen.«module» func14 _ initial
...
theorem normalized_momentum_exact (env : HostEnv Unit) (initial : Store Unit) (word top : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 17 initial [.i64 top, .i64 word]
  ...
  change wp Project.EulerRiemann.Frozen.«module» func17 _ initial
...
theorem tiny_residual_exact (env : HostEnv Unit) (initial : Store Unit) (rho mx my energy : UInt64) :
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 18 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func18 _ initial
