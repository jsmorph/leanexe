import Project.EulerRiemann.FrozenExecutionSweep
...
theorem sweep_owned (env : HostEnv Unit) (initial : Store Unit) (heap : Heap)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 77 initial
  ...
  · exact (hTotal.memoryCap Project.EulerRiemann.Frozen.«module» 0).trans
      (heap.allocateStore_memoryCap initial need Project.EulerRiemann.Frozen.«module» 0)
