...
import Project.EulerRiemann.FrozenGeometry
...
theorem neighborIndex_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerRiemann.Frozen.«module» 37 initial
  ...
  change wp Project.EulerRiemann.Frozen.«module» func37 _ initial
