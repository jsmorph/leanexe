import Project.EulerRiemann.FrozenRetryIteration
...
theorem retry_loop_spec (env : HostEnv Unit) (initial : Store Unit) (initialHeap : Heap)
    ...
    (hNext : ∀ final heap resultFrame,
      ...
      wp Project.EulerRiemann.Frozen.«module» rest Q final resultFrame env) :
    wp Project.EulerRiemann.Frozen.«module» ([.block 0 0 [.loop 0 0 retryLoop]] ++ rest)
