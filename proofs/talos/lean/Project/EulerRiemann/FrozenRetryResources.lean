import Project.EulerRiemann.FrozenRetryInvariant
...
theorem RetryStoreAt.after_step {initial current final : Store Unit}
    ...
    (hCap : final.memoryCap Project.EulerRiemann.Frozen.«module» 0 = current.memoryCap Project.EulerRiemann.Frozen.«module» 0)
    (result : FreeNode)
