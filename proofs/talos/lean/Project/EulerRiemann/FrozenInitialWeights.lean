import Project.EulerRiemann.FrozenInitialWeight
...
theorem initial_weights_spec (env : HostEnv Unit) (store : Store Unit) (frame : Locals)
    ...
    (hNext : ∀ resultFrame, resultFrame.params = frame.params →
      ...
      wp Project.EulerRiemann.Frozen.«module» rest Q store resultFrame env) :
    wp Project.EulerRiemann.Frozen.«module» (func94.take 66 ++ rest) Q store frame env := by
