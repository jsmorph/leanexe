...
theorem output_append_spec (env : HostEnv Unit) (initial : Store Unit) (frame : Locals)
    ...
    (hNext : ∀ (final : Store Unit) (finalFrame : Locals),
      ...
      finalFrame.get 49 = frame.get 49 → finalFrame.get 70 = some (.i64 empty) →
  ...
  apply hNext _ _ hResult.1 hResult.2.1
    ...
    (hGets.2.2.2.trans ((hCopiedGet 70 (by decide)).trans
      ((hPreserved 70 (by decide) (by decide)).trans hOwned))) hResult.2.2.1 hResult.2.2.2.1 hResult.2.2.2.2
