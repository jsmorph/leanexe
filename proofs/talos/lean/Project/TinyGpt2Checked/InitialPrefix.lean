...
theorem inference_prefix_shape : func84.take 52 =
    inferenceHiddenPrefix ++ FixedArrayCapacity.constantProgram 0 1 55 := rfl
...
theorem inference_prefix_spec (env : HostEnv Unit) (initial : Store Unit)
  ...
  apply FixedArrayCapacity.constantProgram_spec 0 1 55 module env initial _ rfl
    (by change 6 ≤ 55; decide) (by change 55 < 6 + 68; decide)
