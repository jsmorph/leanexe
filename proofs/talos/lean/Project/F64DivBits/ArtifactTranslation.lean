import Project.F64DivBits.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.F64DivBits.func0Def, Project.F64DivBits.func1Def, Project.F64DivBits.func2Def, Project.F64DivBits.func3Def, Project.F64DivBits.func4Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq]

def executionCache : Wasm.Module :=
  Project.F64DivBits.«module»
