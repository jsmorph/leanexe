...
The completed `gpt2_quantized_linear_rows` case proves the [quantized projection](../../../../../LeanExe/Models/Gpt2/Quantized/Kernel.lean) against its exact 4,757-byte WASM binary.  The [implementation plan](../../../../../plans/gpt2-quantized.md) places cached-model integration after this projection milestone.
...
The [exact-binary theorem](ArtifactTranslation.lean), `artifact_linearRows_exact`, proves decoding, grammar membership, validation, `CoreValid`, and the complete entry specification for the decoded binary.  The [frozen package](../../../../artifacts/gpt2_quantized_linear_rows/de0f34ec5a1c97a54f39c7664071278301923aebc663100fcc1002182ef9ab7a/manifest.json) identifies SHA-256 `de0f34ec5a1c97a54f39c7664071278301923aebc663100fcc1002182ef9ab7a`.  This is the binary used in the [projection measurements](../../../../../data/gpt2-quantized-v1/README.md).  The focused source gate and independent artifact check passed.  The theorem audit reports only `propext`, `Classical.choice`, and `Quot.sound`.

```sh
tools/talos-artifact.js prepare gpt2_quantized_linear_rows
tools/talos-proof.js check gpt2_quantized_linear_rows
tools/artifact-proof.js check proofs/artifacts/gpt2_quantized_linear_rows/de0f34ec5a1c97a54f39c7664071278301923aebc663100fcc1002182ef9ab7a/program.wasm Project.Gpt2QuantizedLinearRows.ArtifactTranslation
```

The checked-wrapper theorem, full cached model, and renewed aggregate checks remain open.  The four new instruction forms changed the shared verifier digest.  Older artifact manifests now record that digest, with unchanged frozen binaries and proof statements.
