import Project.Gpt2QuantizedLinearRows.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.Gpt2QuantizedLinearRows.func0Def, Project.Gpt2QuantizedLinearRows.func1Def, Project.Gpt2QuantizedLinearRows.func2Def, Project.Gpt2QuantizedLinearRows.func3Def, Project.Gpt2QuantizedLinearRows.func4Def, Project.Gpt2QuantizedLinearRows.func5Def, Project.Gpt2QuantizedLinearRows.func6Def, Project.Gpt2QuantizedLinearRows.func7Def, Project.Gpt2QuantizedLinearRows.func8Def, Project.Gpt2QuantizedLinearRows.func9Def, Project.Gpt2QuantizedLinearRows.func10Def, Project.Gpt2QuantizedLinearRows.func11Def, Project.Gpt2QuantizedLinearRows.func12Def]
...
def executionCache : Wasm.Module :=
  Project.Gpt2QuantizedLinearRows.«module»
...
theorem artifact_linearRows_exact :
    ∃ raw validated,
      decode artifactBytes = .ok raw ∧
      Grammar.Encodes artifactBytes raw ∧
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Project.Gpt2QuantizedLinearRows.Spec.ExactSpecFor validated.toTalos := by
  obtain ⟨raw, validated, hDecode, hValidate, hValid, hBehavior⟩ :=
    artifact_correct_of Project.Gpt2QuantizedLinearRows.Spec.ExactSpecFor
      Project.Gpt2QuantizedLinearRows.Spec.linearRows_exact_for
  exact ⟨raw, validated, hDecode, Proof.decode_sound hDecode, hValidate, hValid, hBehavior⟩

#print axioms artifact_linearRows_exact
