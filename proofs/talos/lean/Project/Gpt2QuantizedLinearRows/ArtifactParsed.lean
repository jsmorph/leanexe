...
theorem sections_from6 :
    sectionLoop 4743 6 state6 { bytes := artifactBytes, pos := 4757, limit := 4757 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 4757, limit := 4757 }) := by rfl

theorem sections_from5 :
    sectionLoop 4744 5 state5 { bytes := artifactBytes, pos := 301, limit := 4757 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 4757, limit := 4757 }) := by
  refine sectionLoop_eq_step (fuel := 4743) (rawId := 10) (id := .code) (rank := 6)
    (payload := { bytes := artifactBytes, pos := 302, limit := 4757 }) (next := { bytes := artifactBytes, pos := 4757, limit := 4757 })
...
theorem sections_from4 :
    sectionLoop 4745 4 state4 { bytes := artifactBytes, pos := 180, limit := 4757 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 4757, limit := 4757 }) := by
  refine sectionLoop_eq_step (fuel := 4744) (rawId := 7) (id := .export) (rank := 5)
    (payload := { bytes := artifactBytes, pos := 181, limit := 4757 }) (next := { bytes := artifactBytes, pos := 301, limit := 4757 })
...
theorem sections_from3 :
    sectionLoop 4746 3 state3 { bytes := artifactBytes, pos := 146, limit := 4757 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 4757, limit := 4757 }) := by
  refine sectionLoop_eq_step (fuel := 4745) (rawId := 6) (id := .global) (rank := 4)
    (payload := { bytes := artifactBytes, pos := 147, limit := 4757 }) (next := { bytes := artifactBytes, pos := 180, limit := 4757 })
...
theorem sections_from2 :
    sectionLoop 4747 2 state2 { bytes := artifactBytes, pos := 141, limit := 4757 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 4757, limit := 4757 }) := by
  refine sectionLoop_eq_step (fuel := 4746) (rawId := 5) (id := .memory) (rank := 3)
    (payload := { bytes := artifactBytes, pos := 142, limit := 4757 }) (next := { bytes := artifactBytes, pos := 146, limit := 4757 })
...
theorem sections_from1 :
    sectionLoop 4748 1 state1 { bytes := artifactBytes, pos := 125, limit := 4757 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 4757, limit := 4757 }) := by
  refine sectionLoop_eq_step (fuel := 4747) (rawId := 3) (id := .function) (rank := 2)
    (payload := { bytes := artifactBytes, pos := 126, limit := 4757 }) (next := { bytes := artifactBytes, pos := 141, limit := 4757 })
...
theorem sections_from0 :
    sectionLoop 4749 0 state0 { bytes := artifactBytes, pos := 8, limit := 4757 } =
      .ok (Cache.raw, { bytes := artifactBytes, pos := 4757, limit := 4757 }) := by
  refine sectionLoop_eq_step (fuel := 4748) (rawId := 1) (id := .type) (rank := 1)
    (payload := { bytes := artifactBytes, pos := 9, limit := 4757 }) (next := { bytes := artifactBytes, pos := 125, limit := 4757 })
...
theorem decode_eq_cache_parts : decode artifactBytes = .ok Cache.raw := by
  refine decode_eq_of_parts (versionStart := { bytes := artifactBytes, pos := 4, limit := 4757 })
    (sectionsStart := { bytes := artifactBytes, pos := 8, limit := 4757 }) (finish := { bytes := artifactBytes, pos := 4757, limit := 4757 }) ?_ ?_ ?_ ?_
  · cbv
  · cbv
