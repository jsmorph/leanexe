...
namespace Project.Gpt2QuantizedLinearRows.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [108, 105, 110, 101, 97, 114, 82, 111, 119, 115], text := "linearRows" },
  ...
  codes := [{ locals := [{ count := 6, type := Wasm.Binary.ValType.i64 }],
            ...
            { locals := [{ count := 73, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 0,
                       ...
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.empty)
                         [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 74]
                         none,
                       Wasm.Binary.Instr.i64Const 0,
                            ...
                            [Wasm.Binary.Instr.localGet 76,
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               [Wasm.Binary.Instr.localGet 75,
                                ...
                                Wasm.Binary.Instr.iff
                                  (Wasm.Binary.BlockType.empty)
                                  [Wasm.Binary.Instr.localGet 78, Wasm.Binary.Instr.globalSet 1]
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               [Wasm.Binary.Instr.i64Const 0,
                                ...
                                Wasm.Binary.Instr.iff
                                  (Wasm.Binary.BlockType.value (Wasm.Binary.ValType.i64))
                                  [Wasm.Binary.Instr.localGet 79]
                                  (some [Wasm.Binary.Instr.localGet 79,
                                    Wasm.Binary.Instr.localGet 80,
                                ...
                                Wasm.Binary.Instr.iff
                                  ...
                                  (some [Wasm.Binary.Instr.localGet 82,
                                    Wasm.Binary.Instr.localGet 83,
                                    Wasm.Binary.Instr.i64RemU]),
                                Wasm.Binary.Instr.localSet 80,
                                Wasm.Binary.Instr.i64Const 4,
                       ...
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.empty)
                         [Wasm.Binary.Instr.localGet 16, Wasm.Binary.Instr.call 12]
                         (some []),
                       Wasm.Binary.Instr.localGet 19,
                       Wasm.Binary.Instr.i64Const 0,
                       Wasm.Binary.Instr.i64Eq,
                       ...
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.empty)
                         [Wasm.Binary.Instr.localGet 19, Wasm.Binary.Instr.call 12]
                         (some []),
...
end Project.Gpt2QuantizedLinearRows.Artifact.Cache
