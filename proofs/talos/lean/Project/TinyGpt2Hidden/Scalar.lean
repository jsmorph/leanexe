...
theorem dot8_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.TinyGpt2Hidden.module 65 initial
  ...
  change wp Project.TinyGpt2Hidden.module func65 _ initial
    (func65Def.toLocals [.i64 x0, .i64 x1, .i64 x2, .i64 x3, .i64 x4, .i64 x5, .i64 x6, .i64 x7,
...
theorem activate_exact (env : HostEnv Unit) (initial : Store Unit) (x : Row) :
    TerminatesWith env Project.TinyGpt2Hidden.module 62 initial (rowResults x)
  ...
  change wp Project.TinyGpt2Hidden.module func62 _ initial
    (func62Def.toLocals [.i64 x.x0, .i64 x.x1, .i64 x.x2, .i64 x.x3]) env
  unfold func62
  repeat first
    | wp_fixed_frame [func62Def]
...
theorem attentionScore_exact (env : HostEnv Unit) (initial : Store Unit) (q0 q1 k0 k1 : UInt64) :
    TerminatesWith env Project.TinyGpt2Hidden.module 41 initial
      [.i64 k1, .i64 k0, .i64 q1, .i64 q0]
      (fun final values => final = initial ∧ values = [.i64 (attentionScore q0 q1 k0 k1)]) := by
  refine TerminatesWith.of_wp_entry_for (f := func41Def) rfl ?_ (by decide)
  change wp Project.TinyGpt2Hidden.module func41 _ initial
    (func41Def.toLocals [.i64 q0, .i64 q1, .i64 k0, .i64 k1]) env
  unfold func41
  wp_fixed_frame [func41Def]
  refine wp_call_tw (dot2_exact env initial _ _ _ _) ?_
  rintro st values ⟨hst, rfl⟩
  subst st
  wp_fixed_frame [func41Def]
