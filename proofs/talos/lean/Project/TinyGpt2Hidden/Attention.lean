...
theorem headProbabilities_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.TinyGpt2Hidden.module 46 initial
  ...
  change wp Project.TinyGpt2Hidden.module func46 _ initial
    (func46Def.toLocals [.i64 n, .i64 q0, .i64 q1,
      .i64 k0.x0, .i64 k0.x1, .i64 k0.x2, .i64 k0.x3,
      .i64 k1.x0, .i64 k1.x1, .i64 k1.x2, .i64 k1.x3]) env
  unfold func46
  repeat first
    | wp_fixed_frame [func46Def, Softmax.Spec.resultWords]
...
theorem weightedValue_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.TinyGpt2Hidden.module 51 initial
  ...
  change wp Project.TinyGpt2Hidden.module func51 _ initial
    (func51Def.toLocals [.i64 p.status, .i64 p.p0, .i64 p.p1, .i64 p.p2, .i64 p.p3,
      .i64 v0, .i64 v1, .i64 v2, .i64 v3]) env
  unfold func51
  wp_fixed_frame [func51Def]
...
theorem attentionRow_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.TinyGpt2Hidden.module 52 initial
  ...
  refine TerminatesWith.of_wp_entry_for (f := func52Def) rfl ?_ (by decide)
  change wp Project.TinyGpt2Hidden.module func52 _ initial
    (func52Def.toLocals ([.i64 n] ++ (rowResults q).reverse ++
  ...
  wp_fixed_frame [func52Def, contextResults, rowResults]
  ...
  rintro st values ⟨hst, rfl⟩
  subst st
  wp_fixed_frame [func52Def, Softmax.Spec.resultWords]
