import Project.EulerOutwardCfl.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.EulerOutwardCfl.func0Def, Project.EulerOutwardCfl.func1Def, Project.EulerOutwardCfl.func2Def, Project.EulerOutwardCfl.func3Def, Project.EulerOutwardCfl.func4Def, Project.EulerOutwardCfl.func5Def, Project.EulerOutwardCfl.func6Def, Project.EulerOutwardCfl.func7Def, Project.EulerOutwardCfl.func8Def, Project.EulerOutwardCfl.func9Def, Project.EulerOutwardCfl.func10Def, Project.EulerOutwardCfl.func11Def, Project.EulerOutwardCfl.func12Def, Project.EulerOutwardCfl.func13Def, Project.EulerOutwardCfl.func14Def, Project.EulerOutwardCfl.func15Def, Project.EulerOutwardCfl.func16Def, Project.EulerOutwardCfl.func17Def, Project.EulerOutwardCfl.func18Def, Project.EulerOutwardCfl.func19Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq, function5_eq, function6_eq, function7_eq, function8_eq, function9_eq, function10_eq, function11_eq, function12_eq, function13_eq, function14_eq, function15_eq, function16_eq, function17_eq, function18_eq, function19_eq]

def executionCache : Wasm.Module :=
  Project.EulerOutwardCfl.«module»
...
theorem artifact_gridRatioChecked_exact :
    ∃ raw validated,
      decode artifactBytes = .ok raw ∧
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Spec.ExactSpecFor validated.toTalos := by
  exact artifact_correct_of Spec.ExactSpecFor Spec.gridRatioChecked_exact

#print axioms artifact_gridRatioChecked_exact

theorem artifact_gridRatioChecked_behavior :
    ∃ raw validated,
      decode artifactBytes = .ok raw ∧
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Spec.BehaviorSpecFor validated.toTalos := by
  exact artifact_correct_of Spec.BehaviorSpecFor Spec.gridRatioChecked_behavior

#print axioms artifact_gridRatioChecked_behavior
