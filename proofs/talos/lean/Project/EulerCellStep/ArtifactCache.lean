...
namespace Project.EulerCellStep.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 26 },
              ...
              { name := { bytes := [114, 101, 116, 97, 105, 110], text := "retain" },
                desc := Wasm.Binary.ExportDesc.func 28 },
              { name := { bytes := [114, 101, 108, 101, 97, 115, 101], text := "release" },
                desc := Wasm.Binary.ExportDesc.func 29 },
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 29 },
...
end Project.EulerCellStep.Artifact.Cache
