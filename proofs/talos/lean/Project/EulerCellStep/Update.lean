...
open Project.EulerDynamicFlux.Execution (rejectedComponent_exact)
...
theorem updateCheckedBits_exact_in_module {m : Wasm.Module} (layout : Layout m)
  ...
  refine TerminatesWith.of_wp_entry_for (f := func19Def)
    (by simpa [layout.noImports] using layout.update) ?_ (by simp [layout.noImports])
  ...
  refine wp_call_tw (positiveBits_exact layout.toLayout.toHelperLayout env initial ratio) ?_
  rintro st values ⟨hst, rfl⟩
  subst st
  cases h0 : Project.EulerConservative.Model.positiveBits ratio
  · dynamic_peel
    refine wp_call_tw (rejectedComponent_exact layout.toLayout env initial) ?_
    rintro st values ⟨hst, rfl⟩
    subst st
    dynamic_peel
    simp [updateValues, Model.updateCheckedBits, Project.EulerDynamicFlux.Model.rejectedComponent, *]
  · dynamic_peel
    refine wp_call_tw (finiteBits_exact layout.toLayout.toHelperLayout env initial state) ?_
    rintro st values ⟨hst, rfl⟩
    subst st
    ...
    · dynamic_peel
      ...
      simp [updateValues, Model.updateCheckedBits, Project.EulerDynamicFlux.Model.rejectedComponent, *]
    · dynamic_peel
      refine wp_call_tw (finiteBits_exact layout.toLayout.toHelperLayout env initial fluxL) ?_
      rintro st values ⟨hst, rfl⟩
      subst st
      ...
      · dynamic_peel
        ...
        simp [updateValues, Model.updateCheckedBits, Project.EulerDynamicFlux.Model.rejectedComponent, *]
      · dynamic_peel
        refine wp_call_tw (finiteBits_exact layout.toLayout.toHelperLayout env initial fluxR) ?_
        rintro st values ⟨hst, rfl⟩
        subst st
        ...
        · dynamic_peel
          ...
          simp [updateValues, Model.updateCheckedBits, Project.EulerDynamicFlux.Model.rejectedComponent, *]
        · dynamic_peel
          refine wp_call_tw (finiteBits_exact layout.toLayout.toHelperLayout env initial difference) ?_
          rintro st values ⟨hst, rfl⟩
          subst st
          ...
          · dynamic_peel
            refine wp_call_tw (finiteBits_exact layout.toLayout.toHelperLayout env initial increment) ?_
            rintro st values ⟨hst, rfl⟩
            subst st
            ...
            · dynamic_peel
              refine wp_call_tw (finiteBits_exact layout.toLayout.toHelperLayout env initial value) ?_
              rintro st values ⟨hst, rfl⟩
              subst st
