import Project.EulerRusanov.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.EulerRusanov.func0Def, Project.EulerRusanov.func1Def, Project.EulerRusanov.func2Def, Project.EulerRusanov.func3Def, Project.EulerRusanov.func4Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq]

def executionCache : Wasm.Module :=
  Project.EulerRusanov.«module»
