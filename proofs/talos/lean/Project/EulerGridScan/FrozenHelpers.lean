...
import Project.EulerGridStep.FrozenScan
...
theorem concreteLayout : Layout Project.EulerGridScan.Frozen.«module» := by
...
def iterationValues (input : Array UInt64) (index : Nat) (speed : UInt64) : List Wasm.Value :=
  let result := Project.EulerGridStep.Frozen.Model.scan input index speed 1
