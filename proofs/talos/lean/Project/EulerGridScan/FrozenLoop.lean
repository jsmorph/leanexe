import Project.EulerGridScan.FrozenLoopFrame
...
theorem scan_loop_spec {m : Wasm.Module} (layout : Layout m)
    ...
    (target : Project.EulerGridStep.Frozen.Model.CheckedSpeed)
  ...
  · rintro current frame ⟨hCurrent, i, st, sp, sc, hi, ht, hFrame⟩
    ...
    · have hEncoded := hComparison.mpr hlt
      ...
      · have hCellIndex : i < input.size / 3 := hCellBound i hlt
        ...
        generalize hModel : Project.EulerGridStep.Frozen.Model.scan input i sp 1 = next at stepProof hRest
