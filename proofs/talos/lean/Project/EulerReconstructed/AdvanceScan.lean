...
theorem advance_scan_spec (env : HostEnv Unit) (store : Store Unit) (frame : Locals)
    (n : Nat) (fuel trials time source : UInt64) (grid : Array Project.EulerRiemann.Traversal.Cell)
    ...
    wp Project.EulerReconstructed.«module» (advanceWorkBody.take 13 ++ rest) Q store frame env := by
