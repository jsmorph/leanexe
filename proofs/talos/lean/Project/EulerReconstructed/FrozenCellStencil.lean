...
open Project.EulerRiemann.Frozen.Traversal (Cell neighborIndex)
open Project.EulerRiemann.Frozen.Execution (stateValues cellValues boolWord)
...
theorem cellStencil_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerReconstructed.Frozen.«module» 57 initial
  ...
  change wp Project.EulerReconstructed.Frozen.«module» func57 _ initial
