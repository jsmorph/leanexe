import Project.EulerReconstructed.SolveInitial
import Project.EulerReconstructed.TraceSafety
import Project.EulerReconstructed.PhysicalTrace

namespace Project.EulerReconstructed.Spec
open Wasm
...
def Successful (n trials : Nat) : Prop :=
  (Control.solve n trials)[0]? = some 0 →
    ...
    ∃ dts, Control.NumericalTrace n trials 0 (Project.EulerRiemann.Traversal.initialCells n)
...
end Project.EulerReconstructed.Spec
