import Project.EulerReconstructed.ExecutionSweep
...
theorem sweep_owned (env : HostEnv Unit) (initial : Store Unit) (heap : Heap)
    ...
    TerminatesWith env Project.EulerReconstructed.«module» 121 initial
  ...
  · exact (hTotal.memoryCap Project.EulerReconstructed.«module» 0).trans
      (heap.allocateStore_memoryCap initial need Project.EulerReconstructed.«module» 0)
