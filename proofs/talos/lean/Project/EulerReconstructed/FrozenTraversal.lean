...
open Project.EulerRiemann.Frozen.Traversal (Cell neighborIndex accepted)
...
def updateCell (n fuel : Nat) (axis : Bool) (ratio : UInt64)
  ...
  let out := Project.EulerRiemann.Frozen.OutwardNumerics.reconstructedStepCheckedBits fuel ratio
