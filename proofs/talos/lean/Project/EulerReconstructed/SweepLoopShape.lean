import Project.EulerReconstructed.UpdateCell
...
structure SweepScratch where
  cell : Project.EulerRiemann.Traversal.Cell := ⟨0, ⟨0, 0, 0, 0⟩, 0, 0⟩
  result : Project.EulerRiemann.Traversal.Cell := ⟨0, ⟨0, 0, 0, 0⟩, 0, 0⟩
  n : UInt64 := 0
  fuel : UInt64 := 0
  axis : UInt64 := 0
  ratio : UInt64 := 0
...
def sweepInvariant (initial : Store Unit) (n : Nat) (fuel : UInt64) (axis : Bool)
    (ratio owner source target : UInt64) (grid : Array Project.EulerRiemann.Traversal.Cell)
