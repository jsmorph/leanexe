import Project.EulerReconstructed.CellStencil
import Project.EulerReconstructed.ReconstructedStep
...
open Project.EulerRiemann.Execution (cellValues stateValues boolWord)
...
theorem updateCell_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerReconstructed.«module» 120 initial
  ...
  change wp Project.EulerReconstructed.«module» func120 _ initial
