import Project.EulerReconstructed.FrozenAdvanceTotalLoop
...
theorem advance_pages_exact (env : HostEnv Unit) (initial : Store Unit) (heap : Heap)
    (source : FreeNode) (grid : Array Project.EulerRiemann.Frozen.Traversal.Cell) (n : Nat) (fuel trials time : UInt64)
