import Project.EulerReconstructed.SweepLoopShape
...
theorem sweep_loop_spec (env : HostEnv Unit) (initial : Store Unit)
    ...
    (grid : Array Project.EulerRiemann.Traversal.Cell) (hn : 2 ≤ n ∧ n ≤ 800)
    (hIndexed : Project.EulerRiemann.Traversal.Indexed n grid)
    ...
    wp Project.EulerReconstructed.«module» ([.block 0 0 [.loop 0 0 sweepLoop]] ++ rest) Q initial
