import Project.EulerReconstructed.AdvanceTotalInvariant
import Project.EulerReconstructed.AdvanceTotalTrial
...
theorem advance_total_work_spec (env : HostEnv Unit) (initial : Store Unit) (initialHeap : Heap)
    ...
    (source : FreeNode) (grid : Array Project.EulerRiemann.Traversal.Cell) (tracked : Bool)
