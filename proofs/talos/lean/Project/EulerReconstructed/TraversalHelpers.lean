...
theorem neighborIndex_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerReconstructed.«module» 54 initial
  ...
  Project.FunctionRegion.terminatesWith RiemannRegion.shift 37
    ...
    (Project.EulerRiemann.Execution.neighborIndex_exact env initial n index axis forward hn hi)

theorem orient_exact (env : HostEnv Unit) (initial : Store Unit)
    (axis : Bool) (state : State) :
    TerminatesWith env Project.EulerReconstructed.«module» 56 initial
  ...
  Project.FunctionRegion.terminatesWith RiemannRegion.shift 39
    (by norm_num [RiemannRegion.domain])
    (Project.EulerRiemann.Execution.orient_exact env initial axis state)
...
theorem accepted_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerReconstructed.«module» 123 initial
  ...
  Project.FunctionRegion.terminatesWith RiemannRegion.shift 79
    (by norm_num [RiemannRegion.domain])
    (Project.EulerRiemann.Execution.accepted_exact env initial owner pointer grid hGrid)
