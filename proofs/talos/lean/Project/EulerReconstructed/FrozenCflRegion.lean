...
namespace Project.EulerReconstructed.Frozen.CflRegion
...
theorem shift :
    Shift Project.EulerOutwardCfl.«module» Project.EulerReconstructed.Frozen.«module»
...
#print axioms shift
end Project.EulerReconstructed.Frozen.CflRegion
