import Project.EulerReconstructed.FrozenScanLoop
...
theorem scan_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerReconstructed.Frozen.«module» 46 initial
  ...
  change wp Project.EulerReconstructed.Frozen.«module» func46 _ initial
