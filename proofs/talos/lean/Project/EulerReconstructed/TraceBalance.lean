import Project.EulerReconstructed.StepBalance
import Project.EulerReconstructed.ControlTrace

namespace Project.EulerReconstructed.Conservation
open Project.EulerRiemann.Traversal (Cell Indexed asGrid initialCells initialCells_indexed)
open Project.EulerRiemann.Conservation (gridTotal)

def traceRatio (n : Nat) (dt : UInt64) (grid : Array Cell) : UInt64 :=
  (Project.EulerRiemann.OutwardCfl.gridRatioChecked n dt
    (Project.EulerRiemann.OutwardMaximum.gridUpper grid).value).value
