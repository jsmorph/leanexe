import Project.EulerReconstructed.AdvanceGuard
...
theorem advance_continue_spec (env : HostEnv Unit) (store : Store Unit) (heap : Heap)
    ...
    (hNext : wp Project.EulerReconstructed.«module» rest Q
    ...
    wp Project.EulerReconstructed.«module» (advanceContinueBody ++ rest) Q store
