...
namespace Project.EulerReconstructed.Frozen.RiemannRegion
...
theorem shift :
    Shift Project.EulerRiemann.Frozen.«module» Project.EulerReconstructed.Frozen.«module»
...
#print axioms shift
end Project.EulerReconstructed.Frozen.RiemannRegion
