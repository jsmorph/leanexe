import Project.EulerReconstructed.FrozenSweepOwned
...
theorem sweep_pages_owned (env : HostEnv Unit) (initial : Store Unit) (heap : Heap)
    ...
    (pageLimit : Nat) (hn : 2 ≤ n ∧ n ≤ 800) (hIndexed : Project.EulerRiemann.Frozen.Traversal.Indexed n grid)
  ...
  apply (sweep_owned env initial heap source grid n fuel axis ratio hn hIndexed hHeap hOwner
