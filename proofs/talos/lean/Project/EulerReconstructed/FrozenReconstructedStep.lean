...
import Project.EulerRiemann.FrozenReconstructedStep
...
theorem reconstructed_step_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.EulerReconstructed.Frozen.«module» 108 initial
  ...
  change wp Project.EulerReconstructed.Frozen.«module» func108 _ initial
  ...
  dsimp only [ModelAgreement.faces]
