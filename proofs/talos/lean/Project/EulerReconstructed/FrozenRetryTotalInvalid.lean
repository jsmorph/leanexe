...
theorem retry_total_invalid_spec (env : HostEnv Unit) (initial : Store Unit) (initialHeap : Heap)
    (n : Nat) (fuel trials time dt alpha source : UInt64) (grid : Array Project.EulerRiemann.Frozen.Traversal.Cell)
    ...
    wp module (retryFailureProgram 3 ++ [.constI64 1, .localSet 13] ++ rest) Q
