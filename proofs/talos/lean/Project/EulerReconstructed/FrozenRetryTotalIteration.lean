import Project.EulerReconstructed.FrozenRetryTotalValid
import Project.EulerReconstructed.FrozenRetryTotalInvalid
...
theorem retry_total_iteration_spec (env : HostEnv Unit) (initial : Store Unit) (initialHeap : Heap)
    (source : FreeNode) (grid : Array Project.EulerRiemann.Frozen.Traversal.Cell) (n : Nat) (trials time alpha : UInt64)
