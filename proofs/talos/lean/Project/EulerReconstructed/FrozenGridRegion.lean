...
namespace Project.EulerReconstructed.Frozen.GridRegion
...
theorem shift :
    Shift Project.EulerOutwardGrid.«module» Project.EulerReconstructed.Frozen.«module»
...
#print axioms shift
end Project.EulerReconstructed.Frozen.GridRegion
