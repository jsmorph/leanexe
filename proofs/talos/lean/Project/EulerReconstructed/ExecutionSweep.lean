import Project.EulerReconstructed.SweepSetup
import Project.EulerRiemann.MemoryLength
import Project.EulerReconstructed.SweepLoop
...
theorem sweep_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    (grid : Array Project.EulerRiemann.Traversal.Cell) (nodes : List FreeNode) (hn : 2 ≤ n ∧ n ≤ 800)
    (hIndexed : Project.EulerRiemann.Traversal.Indexed n grid) (hGrid : Memory.GridAt initial source grid)
  ...
  change wp Project.EulerReconstructed.«module» func121 _ initial
