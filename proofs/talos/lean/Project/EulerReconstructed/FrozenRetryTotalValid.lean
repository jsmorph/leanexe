import Project.EulerReconstructed.FrozenRetryTotalStep
...
theorem retry_total_valid_spec (env : HostEnv Unit) (initial : Store Unit) (initialHeap : Heap)
    (source : FreeNode) (grid : Array Project.EulerRiemann.Frozen.Traversal.Cell) (n : Nat)
  ...
  · have hSameStep : (if Project.EulerRiemann.Frozen.Traversal.accepted
