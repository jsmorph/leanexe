...
namespace Project.AssocList.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [108, 111, 111, 107, 117, 112, 68, 101, 109, 111], text := "lookupDemo" },
  ...
  codes := [{ locals := [{ count := 6, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 0,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.i64Const 0, Wasm.Binary.Instr.localSet 6]
            ...
            { locals := [{ count := 42, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 1,
                       ...
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.empty)
                         [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 29]
                         none,
                       Wasm.Binary.Instr.i64Const 0,
                       Wasm.Binary.Instr.localSet 34,
                       Wasm.Binary.Instr.i64Const 0,
                            ...
                            [Wasm.Binary.Instr.localGet 31,
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               [Wasm.Binary.Instr.localGet 30,
                                ...
                                Wasm.Binary.Instr.iff
                                  (Wasm.Binary.BlockType.empty)
                                  [Wasm.Binary.Instr.localGet 33, Wasm.Binary.Instr.globalSet 1]
                       ...
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.empty)
                         [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 15]
                         none,
                       Wasm.Binary.Instr.i64Const 0,
                            ...
                            [Wasm.Binary.Instr.localGet 17,
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               [Wasm.Binary.Instr.localGet 16,
                                ...
                                Wasm.Binary.Instr.iff
                                  (Wasm.Binary.BlockType.empty)
                                  [Wasm.Binary.Instr.localGet 19, Wasm.Binary.Instr.globalSet 1]
                       ...
                       Wasm.Binary.Instr.iff
                         (Wasm.Binary.BlockType.empty)
                         [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 8]
                         none,
                       Wasm.Binary.Instr.i64Const 0,
                            ...
                            [Wasm.Binary.Instr.localGet 10,
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               [Wasm.Binary.Instr.localGet 9,
                                ...
                                Wasm.Binary.Instr.iff
                                  (Wasm.Binary.BlockType.empty)
                                  [Wasm.Binary.Instr.localGet 12, Wasm.Binary.Instr.globalSet 1]
...
end Project.AssocList.Artifact.Cache
