import Project.AssocList.ArtifactValidation
import Project.AssocList.FrozenProgram
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.AssocList.Frozen.func0Def, Project.AssocList.Frozen.func1Def, Project.AssocList.Frozen.func2Def, Project.AssocList.Frozen.func3Def, Project.AssocList.Frozen.func4Def, Project.AssocList.Frozen.func5Def, Project.AssocList.Frozen.func6Def, Project.AssocList.Frozen.func7Def]
...
def executionCache : Wasm.Module :=
  Project.AssocList.Frozen.«module»
