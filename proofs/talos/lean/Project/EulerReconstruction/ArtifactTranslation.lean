import Project.EulerReconstruction.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.EulerReconstruction.func0Def, Project.EulerReconstruction.func1Def, Project.EulerReconstruction.func2Def, Project.EulerReconstruction.func3Def, Project.EulerReconstruction.func4Def, Project.EulerReconstruction.func5Def, Project.EulerReconstruction.func6Def, Project.EulerReconstruction.func7Def, Project.EulerReconstruction.func8Def, Project.EulerReconstruction.func9Def, Project.EulerReconstruction.func10Def, Project.EulerReconstruction.func11Def, Project.EulerReconstruction.func12Def, Project.EulerReconstruction.func13Def, Project.EulerReconstruction.func14Def, Project.EulerReconstruction.func15Def, Project.EulerReconstruction.func16Def, Project.EulerReconstruction.func17Def, Project.EulerReconstruction.func18Def, Project.EulerReconstruction.func19Def, Project.EulerReconstruction.func20Def, Project.EulerReconstruction.func21Def, Project.EulerReconstruction.func22Def, Project.EulerReconstruction.func23Def, Project.EulerReconstruction.func24Def, Project.EulerReconstruction.func25Def, Project.EulerReconstruction.func26Def, Project.EulerReconstruction.func27Def, Project.EulerReconstruction.func28Def, Project.EulerReconstruction.func29Def, Project.EulerReconstruction.func30Def, Project.EulerReconstruction.func31Def, Project.EulerReconstruction.func32Def, Project.EulerReconstruction.func33Def, Project.EulerReconstruction.func34Def, Project.EulerReconstruction.func35Def, Project.EulerReconstruction.func36Def, Project.EulerReconstruction.func37Def, Project.EulerReconstruction.func38Def, Project.EulerReconstruction.func39Def, Project.EulerReconstruction.func40Def, Project.EulerReconstruction.func41Def, Project.EulerReconstruction.func42Def, Project.EulerReconstruction.func43Def, Project.EulerReconstruction.func44Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq, function5_eq, function6_eq, function7_eq, function8_eq, function9_eq, function10_eq, function11_eq, function12_eq, function13_eq, function14_eq, function15_eq, function16_eq, function17_eq, function18_eq, function19_eq, function20_eq, function21_eq, function22_eq, function23_eq, function24_eq, function25_eq, function26_eq, function27_eq, function28_eq, function29_eq, function30_eq, function31_eq, function32_eq, function33_eq, function34_eq, function35_eq, function36_eq, function37_eq, function38_eq, function39_eq, function40_eq, function41_eq, function42_eq, function43_eq, function44_eq]

def executionCache : Wasm.Module :=
  Project.EulerReconstruction.«module»
...
theorem artifact_reconstruct_exact :
    ∃ raw validated,
      decode artifactBytes = .ok raw ∧
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Spec.ExactSpecFor validated.toTalos := by
  exact artifact_correct_of Spec.ExactSpecFor Spec.reconstruct_exact

#print axioms artifact_reconstruct_exact

theorem artifact_reconstruct_safe :
    ∃ raw validated,
      decode artifactBytes = .ok raw ∧
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Spec.SafeSpecFor validated.toTalos := by
  exact artifact_correct_of Spec.SafeSpecFor Spec.reconstruct_safe

#print axioms artifact_reconstruct_safe

theorem artifact_reconstruct_accuracy :
    ∃ raw validated,
      decode artifactBytes = .ok raw ∧
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Spec.AccuracySpecFor validated.toTalos := by
  exact artifact_correct_of Spec.AccuracySpecFor Spec.reconstruct_accuracy
