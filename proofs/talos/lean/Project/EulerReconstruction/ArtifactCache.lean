...
namespace Project.EulerReconstruction.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [114, 101, 99, 111, 110, 115, 116, 114, 117, 99, 116], text := "reconstruct" },
                desc := Wasm.Binary.ExportDesc.func 40 },
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 41 },
              ...
              { name := { bytes := [114, 101, 116, 97, 105, 110], text := "retain" },
                desc := Wasm.Binary.ExportDesc.func 43 },
              { name := { bytes := [114, 101, 108, 101, 97, 115, 101], text := "release" },
                desc := Wasm.Binary.ExportDesc.func 44 },
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 44 },
            ...
            { locals := [{ count := 62, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 4,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         (some [Wasm.Binary.Instr.call 29,
            ...
            { locals := [{ count := 78, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 8,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         (some [Wasm.Binary.Instr.call 35,
...
end Project.EulerReconstruction.Artifact.Cache
