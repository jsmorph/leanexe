...
theorem unwind_two_push_spec (env : HostEnv Unit) (store : Store Unit) (heap : Heap)
  ...
  intro altitudeAux hAltitudeLength
  ...
  refine hNext final _ _ altitudeAux _ hAltitudeLength hFinalHeap hFinalBudget hOutput (hKeep.trans hPreserve) ?_
