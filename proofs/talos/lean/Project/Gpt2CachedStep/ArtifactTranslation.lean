...
import Project.Gpt2CachedStep.Session.FrozenSpec
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.Gpt2CachedStep.Frozen.func0Def, Project.Gpt2CachedStep.Frozen.func1Def, Project.Gpt2CachedStep.Frozen.func2Def, Project.Gpt2CachedStep.Frozen.func3Def, Project.Gpt2CachedStep.Frozen.func4Def, Project.Gpt2CachedStep.Frozen.func5Def, Project.Gpt2CachedStep.Frozen.func6Def, Project.Gpt2CachedStep.Frozen.func7Def, Project.Gpt2CachedStep.Frozen.func8Def, Project.Gpt2CachedStep.Frozen.func9Def, Project.Gpt2CachedStep.Frozen.func10Def, Project.Gpt2CachedStep.Frozen.func11Def, Project.Gpt2CachedStep.Frozen.func12Def, Project.Gpt2CachedStep.Frozen.func13Def, Project.Gpt2CachedStep.Frozen.func14Def, Project.Gpt2CachedStep.Frozen.func15Def, Project.Gpt2CachedStep.Frozen.func16Def, Project.Gpt2CachedStep.Frozen.func17Def, Project.Gpt2CachedStep.Frozen.func18Def, Project.Gpt2CachedStep.Frozen.func19Def, Project.Gpt2CachedStep.Frozen.func20Def, Project.Gpt2CachedStep.Frozen.func21Def, Project.Gpt2CachedStep.Frozen.func22Def, Project.Gpt2CachedStep.Frozen.func23Def, Project.Gpt2CachedStep.Frozen.func24Def, Project.Gpt2CachedStep.Frozen.func25Def, Project.Gpt2CachedStep.Frozen.func26Def, Project.Gpt2CachedStep.Frozen.func27Def, Project.Gpt2CachedStep.Frozen.func28Def, Project.Gpt2CachedStep.Frozen.func29Def, Project.Gpt2CachedStep.Frozen.func30Def, Project.Gpt2CachedStep.Frozen.func31Def, Project.Gpt2CachedStep.Frozen.func32Def, Project.Gpt2CachedStep.Frozen.func33Def, Project.Gpt2CachedStep.Frozen.func34Def, Project.Gpt2CachedStep.Frozen.func35Def, Project.Gpt2CachedStep.Frozen.func36Def, Project.Gpt2CachedStep.Frozen.func37Def, Project.Gpt2CachedStep.Frozen.func38Def, Project.Gpt2CachedStep.Frozen.func39Def, Project.Gpt2CachedStep.Frozen.func40Def, Project.Gpt2CachedStep.Frozen.func41Def, Project.Gpt2CachedStep.Frozen.func42Def]
...
def executionCache : Wasm.Module :=
  Project.Gpt2CachedStep.Frozen.«module»
...
theorem artifact_gpt2_128_exact :
    ∃ raw validated,
      ...
      validate raw = .ok validated ∧
      CoreValid raw ∧
      Project.Gpt2CachedStep.Frozen.Spec.ExactSpecFor validated.toTalos := by
  obtain ⟨raw, validated, hdecode, hvalidate, hvalid, hbehavior⟩ :=
    artifact_correct_of Project.Gpt2CachedStep.Frozen.Spec.ExactSpecFor
      Project.Gpt2CachedStep.Frozen.Spec.gpt2_128_exact_for
