import Project.Gpt2CachedStep.LinearRows.DotStep
...
theorem emitted_dot : wordCode = wordCode.take 28 ++ RangeFoldLoop.program 45 46 dotStep ++ wordCode.drop 29 := rfl
