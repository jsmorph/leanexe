import Project.Gpt2QuantizedGroupedRows.ProjectionGroupFinish
...
theorem group_spec (env : HostEnv Unit) (initial : Store Unit)
  ...
  apply finishGroup_spec env initial weightsPtr inputPtr valuePtr scalePtr outputPtr weights input
