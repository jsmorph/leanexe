import Project.Gpt2QuantizedGroupedRows.ProjectionGroups
...
def totalCode (withBias : Bool) : Wasm.Program := ((branch withBias).drop 11).take 3
...
theorem totalCode_spec (env : HostEnv Unit) (initial : Store Unit)
  ...
  cases withBias <;>
    simp only [totalCode, branch, outputWord, outputBody, func8,
