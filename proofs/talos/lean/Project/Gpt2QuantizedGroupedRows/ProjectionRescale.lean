import Project.Gpt2QuantizedGroupedRows.ProjectionDot
...
theorem scaleCode_spec (env : HostEnv Unit) (initial : Store Unit)
  ...
  cases withBias <;>
    simp only [scaleCode, groupStep, groupBody, branch, outputWord, outputBody, func8,
  ...
  all_goals
    ...
    refine PackedWordAccess.guard_spec «module» env initial _ weightsPtr weights
      (scaleOffset + index % outputWidth * 4) 98 99 100
