...
theorem stateGuard_exact {m : Wasm.Module} (layout : HelperLayout m)
  ...
  · side_peel
    ...
    · side_peel
      ...
      · side_peel
        simp [Model.stateGuard, hr, hm, ht, func3Def]
      · side_peel
        ...
        · side_peel
          simp [Model.stateGuard, hr, hm, ht, he, func3Def]
        · side_peel
          ...
          · side_peel
            ...
            all_goals
              side_peel
              simp [Model.stateGuard, hr, hm, ht, he, hmr, htr, hre, func3Def]
          · side_peel
            simp [Model.stateGuard, hr, hm, ht, he, hmr, func3Def]
