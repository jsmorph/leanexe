...
def outputReleaseFrame (frame : Locals) (output : UInt64) : Locals :=
  [(38, output), (39, output), (40, output), (41, output), (64, output), (65, output),
    (63, 0), (23, output), (24, output), (66, 1)].foldl
...
theorem outputReleaseFrame_get (frame : Locals) (output : UInt64)
    ...
    next.get 45 = frame.get 45 ∧ next.get 66 = some (.i64 1) := by
...
theorem output_release_region_spec (env : HostEnv Unit) (initial : Store Unit) (frame : Locals)
    ...
    (hCurrent : frame.get 23 = some (.i64 root)) (hOutput : frame.get 52 = some (.i64 output))
  ...
  have hOutput' := Frame.internal_getElem?_of_get frame 5 47 (.i64 output)
    hParams (by rw [hLocals]; decide) hOutput
  have hOwned' := Frame.internal_getElem?_of_get frame 5 61
