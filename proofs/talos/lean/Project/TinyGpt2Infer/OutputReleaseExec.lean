...
def outputReleaseProgram : Wasm.Program :=
  [.localGet 55, .localSet 38, .localGet 38, .localSet 39,
   .localGet 38, .localSet 40, .localGet 39, .localSet 41,
   .localGet 40, .localSet 67, .localGet 41, .localSet 68, .constI64 0, .localSet 66,
   .localGet 23, .constI64 0, .neI64,
   .localGet 23, .localGet 69, .neI64, .and,
   .localGet 23, .localGet 67, .neI64, .and,
   .iff 0 0 [.localGet 23, .call 82] [],
   .localGet 67, .localSet 23, .localGet 68, .localSet 24,
   .localGet 66, .constI64 0, .neI64, .br_if 1]
...
def outputReleaseFrame (frame : Locals) (output : UInt64) : Locals :=
  [(38, output), (39, output), (40, output), (41, output),
    (67, output), (68, output), (66, 0), (23, output), (24, output)].foldl
