...
theorem output_release_exact (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env module 82 initial [.i64 root]
  ...
  exact FixedArrayRelease.exact env module 82 initial root capacity head releases frees
    output.size 1 (typeIdx := some 82) rfl (by decide) (by omega) (by decide)
