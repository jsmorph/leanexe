...
theorem hidden_exact_for (env : HostEnv Unit) (initial : Store Unit)
    ...
    TerminatesWith env Project.TinyGpt2Infer.module 71 initial
  ...
  proof_step =>
    ...
    change wp Project.TinyGpt2Infer.module func71 _ initial
      (func71Def.toLocals [.i64 owner, .i64 pointer, .i64 t0, .i64 t1, .i64 t2, .i64 t3, .i64 position]) env
    rw [program_eq]
    unfold tail0
