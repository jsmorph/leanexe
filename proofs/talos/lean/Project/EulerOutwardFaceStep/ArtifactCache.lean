...
namespace Project.EulerOutwardFaceStep.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [102, 97, 99, 101, 83, 116, 101, 112, 67, 104, 101, 99, 107, 101, 100, 66, 105, 116,
                                    115],
                          text := "faceStepCheckedBits" },
                desc := Wasm.Binary.ExportDesc.func 70 },
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 71 },
              { name := { bytes := [114, 101, 115, 101, 116], text := "reset" },
                desc := Wasm.Binary.ExportDesc.func 72 },
              { name := { bytes := [114, 101, 116, 97, 105, 110], text := "retain" },
                desc := Wasm.Binary.ExportDesc.func 73 },
              { name := { bytes := [114, 101, 108, 101, 97, 115, 101], text := "release" },
                desc := Wasm.Binary.ExportDesc.func 74 },
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 74 },
                         ...
                         [Wasm.Binary.Instr.localGet 0,
                          ...
                          Wasm.Binary.Instr.iff
                            ...
                            [Wasm.Binary.Instr.i64Const 0,
                             ...
                             Wasm.Binary.Instr.localGet 7,
                             Wasm.Binary.Instr.localSet 15]
                            (some [Wasm.Binary.Instr.call 22,
                              Wasm.Binary.Instr.localSet 11,
                              Wasm.Binary.Instr.localSet 10,
                              Wasm.Binary.Instr.localGet 10,
                              Wasm.Binary.Instr.localSet 14,
                          ...
                          Wasm.Binary.Instr.iff
                            ...
                            [Wasm.Binary.Instr.i64Const 4600877379321698714,
                             ...
                             Wasm.Binary.Instr.iff
                               ...
                               (some [Wasm.Binary.Instr.call 37,
                                 Wasm.Binary.Instr.localSet 43,
                                 Wasm.Binary.Instr.localSet 42,
                                 Wasm.Binary.Instr.localSet 41,
                                 Wasm.Binary.Instr.localSet 40,
                                ...
                                Wasm.Binary.Instr.iff
                                  ...
                                  [Wasm.Binary.Instr.localGet 35,
                                   ...
                                   Wasm.Binary.Instr.iff
                                     ...
                                     (some [Wasm.Binary.Instr.call 68,
                                       Wasm.Binary.Instr.localSet 87,
                                       Wasm.Binary.Instr.localSet 86,
                                       Wasm.Binary.Instr.localSet 85,
                                       Wasm.Binary.Instr.localSet 84,
...
end Project.EulerOutwardFaceStep.Artifact.Cache
