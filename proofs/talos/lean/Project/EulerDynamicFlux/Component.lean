...
open Wasm
open Project.EulerConservative.Execution (positiveBits_exact finiteBits_exact)
...
theorem componentCheckedBits_exact_in_module {m : Wasm.Module} (layout : Layout m)
  ...
  refine wp_call_tw (positiveBits_exact layout.toHelperLayout env initial alpha) ?_
  rintro st values ⟨hst, rfl⟩
  subst st
  cases h0 : Project.EulerConservative.Model.positiveBits alpha
  · dynamic_peel
    refine wp_call_tw (rejectedComponent_exact layout env initial) ?_
    rintro st values ⟨hst, rfl⟩
    subst st
    dynamic_peel
    simp [componentValues, Model.componentCheckedBits, Model.rejectedComponent, *]
  · dynamic_peel
    refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial fluxL) ?_
    rintro st values ⟨hst, rfl⟩
    subst st
    ...
    · dynamic_peel
      ...
      simp [componentValues, Model.componentCheckedBits, Model.rejectedComponent, *]
    · dynamic_peel
      refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial fluxR) ?_
      rintro st values ⟨hst, rfl⟩
      subst st
      ...
      · dynamic_peel
        ...
        simp [componentValues, Model.componentCheckedBits, Model.rejectedComponent, *]
      · dynamic_peel
        refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial stateL) ?_
        rintro st values ⟨hst, rfl⟩
        subst st
        ...
        · dynamic_peel
          ...
          simp [componentValues, Model.componentCheckedBits, Model.rejectedComponent, *]
        · dynamic_peel
          refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial stateR) ?_
          rintro st values ⟨hst, rfl⟩
          subst st
          ...
          · dynamic_peel
            ...
            simp [componentValues, Model.componentCheckedBits, Model.rejectedComponent, *]
          · dynamic_peel
            refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial sum) ?_
            rintro st values ⟨hst, rfl⟩
            subst st
            ...
            · dynamic_peel
              refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial mean) ?_
              rintro st values ⟨hst, rfl⟩
              subst st
              ...
              · dynamic_peel
                refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial jump) ?_
                rintro st values ⟨hst, rfl⟩
                subst st
                ...
                · dynamic_peel
                  refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial viscosity) ?_
                  rintro st values ⟨hst, rfl⟩
                  subst st
                  ...
                  · dynamic_peel
                    refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial halfViscosity) ?_
                    rintro st values ⟨hst, rfl⟩
                    subst st
                    ...
                    · dynamic_peel
                      refine wp_call_tw (finiteBits_exact layout.toHelperLayout env initial value) ?_
                      rintro st values ⟨hst, rfl⟩
                      subst st
