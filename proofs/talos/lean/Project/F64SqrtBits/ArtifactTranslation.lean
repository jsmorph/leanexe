import Project.F64SqrtBits.ArtifactValidation
...
theorem functions_eq : Translation.functions Cache.raw =
  ...
  change
    ...
    [Project.F64SqrtBits.func0Def, Project.F64SqrtBits.func1Def, Project.F64SqrtBits.func2Def, Project.F64SqrtBits.func3Def, Project.F64SqrtBits.func4Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq]

def executionCache : Wasm.Module :=
  Project.F64SqrtBits.«module»
