...
macro "fb_read_candidate_tail " hHead:ident hHeadB:ident hlt:ident
      ...
      · simp [fbFrame]
        ...
        · have hklt : k < os.length := Nat.lt_of_le_of_ne hk hkend
          ...
          | none =>
              ...
              refine wp_call_tw (func5_spec env st2 taker maker) ?_
              ...
              · simp only [boolWord, if_pos helig]
                ...
                norm_num
                refine ⟨hb5, ?_⟩
                refine wp_call_tw (func5_spec env st3 taker maker) ?_
          ...
          | some j =>
              ...
              refine wp_call_tw (func5_spec env st2 taker candidate) ?_
              rintro st3 vs ⟨rfl, rfl⟩
              rw [hcandidate]
              by_cases helig : eligibleL taker os[k]!
              · simp only [boolWord, if_pos helig]
                ...
                · refine wp_iff_cons rfl ?_
                  ...
                  · refine wp_iff_cons rfl ?_
                    ...
                    rw [if_neg (by simp [optionTag])]
                    norm_num
                    fb_read_candidate_tail hHead hHeadB hlt hb1 hb2 hb3 hb4 hb5
                    refine wp_call_tw (func5_spec env st3 taker candidate) ?_
                    rintro st4 vs ⟨rfl, rfl⟩
                    rw [hcandidate]
                    simp only [boolWord, if_pos helig]
                    norm_num
