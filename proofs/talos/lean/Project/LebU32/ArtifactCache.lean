...
namespace Project.LebU32.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [117, 51, 50, 108, 101, 98, 85, 54, 52], text := "u32lebU64" },
                desc := Wasm.Binary.ExportDesc.func 1 },
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 2 },
              ...
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 5 },
  ...
  codes := [{ locals := [{ count := 32, type := Wasm.Binary.ValType.i64 }],
            ...
            { locals := [{ count := 10, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 10,
                       Wasm.Binary.Instr.localSet 1,
                       Wasm.Binary.Instr.localGet 0,
                       Wasm.Binary.Instr.localSet 2,
                       Wasm.Binary.Instr.i64Const 0,
...
end Project.LebU32.Artifact.Cache
