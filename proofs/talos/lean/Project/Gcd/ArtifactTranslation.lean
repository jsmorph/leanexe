...
theorem functions_eq : Translation.functions Cache.raw = Project.Gcd.Frozen.«module».funcs := by
  change
    [Translation.functionToTalos Cache.raw 0 (Cache.raw.codes[0]!),
     ...
     Translation.functionToTalos Cache.raw 3 (Cache.raw.codes[3]!),
     Translation.functionToTalos Cache.raw 4 (Cache.raw.codes[4]!)] =
    [Project.Gcd.Frozen.func0Def, Project.Gcd.Frozen.func1Def, Project.Gcd.Frozen.func2Def,
     Project.Gcd.Frozen.func3Def, Project.Gcd.Frozen.func4Def]
  rw [function0_eq, function1_eq, function2_eq, function3_eq, function4_eq]

def executionCache : Wasm.Module :=
  Project.Gcd.Frozen.«module»
...
theorem executionCache_correct : GcdSpecFor executionCache := by
  simpa [GcdSpecFor, executionCache, Project.Gcd.Frozen.Spec.GcdSpec] using
    Project.Gcd.Frozen.Spec.gcd_correct
