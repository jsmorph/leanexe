...
[loop frame and measure](lean/Project/EulerReconstruction/LoopShape.lean)
check, using the generated guard equality.  Loop execution, the public
wrapper, and exact-byte closure remain open.  The registration is incomplete.
