    ...
    (Inv := fun st1 s1 => st1 = stL ∧ s1 =
      { params := [.i64 (UInt64.ofNat (10 - k)), .i64 v,
        ...
        locals := [.i64 0, .i64 0, .i64 0, .i64 0,
          .i64 (e 9), .i64 (e 10), .i64 (e 11), .i64 (e 12),
          .i64 (v / 128), .i64 (v % 128 + 128 &&& 255),
          .i64 (bufPtr g0 k), .i64 (UInt64.ofNat k),
          .i64 (e 17), .i64 (e 18), .i64 (e 19), .i64 (e 20),
          .i64 (e 21), .i64 (e 22), .i64 (e 23), .i64 (e 24),
          .i64 (bufPtr g0 k), .i64 (UInt64.ofNat k),
          .i64 (v % 128 + 128 &&& 255), .i64 (e 28),
    ...
    apply wp_loop_cons
      ...
      (μ := fun _ sC =>
        ...
        | _ :: _ :: _ :: _ :: _ :: _ :: _ :: _ :: _ :: _ :: _ ::
            ...
            k + 1 - l30.toNat
        | _ => 0)
    · refine ⟨0, Nat.zero_le _, by simp [cFrameNeg], rfl, ?_, ?_,
        ?_, ?_⟩
    ...
    · rintro stC sC ⟨j, hjk, rfl, hglC, hpgC, hdst, hsrc, hloC⟩
      ...
      · subst hjend
        ...
        have hjadd : UInt64.ofNat j + 1 = UInt64.ofNat (j + 1) := by
          ...
          try rw [hjU, size_eq]
          try omega
        have hfuel : UInt64.ofNat (10 - j) - 1 = UInt64.ofNat (10 - (j + 1)) := by
          apply UInt64.toNat.inj
          rw [toNat_sub_le _ _ (by
        ...
        have hgetk : (written ++ [(v % 128 + 128).toUInt8])[j]! =
        ...
        · refine ⟨j + 1, v / 128,
          ...
          · rw [hglC]
            ...
            simp only [if_pos rfl, hl0, decide_true, ite_true,
              Option.some.injEq, Value.i64.injEq]
            apply UInt64.toNat.inj
            simp only [UInt64.toNat_add, UInt64.toNat_mul, UInt64.toNat_ofNat',
              show (48 : UInt64).toNat = 48 from rfl,
              show (8 : UInt64).toNat = 8 from rfl,
          ...
          · have hgeq : g2 + UInt64.ofNat j + 1 =
            ...
            simp only [if_pos rfl, List.length_set]
            rw [if_pos hl2]
