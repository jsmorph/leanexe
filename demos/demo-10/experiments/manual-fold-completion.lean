            ...
            · rintro st frame
              ...
              · subst index
                ...
                · simp only [productFrame,
                  ...
                  simp only [exitFrame, productFrame]
                  ...
                  · simp only [FixedArrayEqNode.branchPost]
                    ...
                    · rw [hExpected]
                      ...
                      change UInt64Array.At
                        ...
                        #[input.foldl
                          (fun product element => product * element) 1]
                      simpa [value, hComplete] using hOutput value
