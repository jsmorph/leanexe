...
theorem function_0_encoded_index_0_tail_eq :
    ((Project.ProofKit.Annotation.resolve LeanExeGen.GeneratedRb9ad29e25c8033e5.func0 [{ instructionIndex := 7, field := .thenBranch }, { instructionIndex := 20, field := .elseBranch }]).getD []).drop 2 =
      LeanExeGen.GeneratedRb9ad29e25c8033e5.AnnotationMatches.function_0_encoded_index_0_program ++ ((Project.ProofKit.Annotation.resolve LeanExeGen.GeneratedRb9ad29e25c8033e5.func0 [{ instructionIndex := 7, field := .thenBranch }, { instructionIndex := 20, field := .elseBranch }]).getD []).drop 8 := by
  rfl
...
theorem function_0_find_idx_eq_0_tail_eq :
    ((Project.ProofKit.Annotation.resolve LeanExeGen.GeneratedRb9ad29e25c8033e5.func0 [{ instructionIndex := 7, field := .thenBranch }]).getD []).drop 0 =
      LeanExeGen.GeneratedRb9ad29e25c8033e5.AnnotationMatches.function_0_find_idx_eq_0_program ++ ((Project.ProofKit.Annotation.resolve LeanExeGen.GeneratedRb9ad29e25c8033e5.func0 [{ instructionIndex := 7, field := .thenBranch }]).getD []).drop 12 := by
  rfl
...
theorem function_0_erase_copy_0_tail_eq :
    ((Project.ProofKit.Annotation.resolve LeanExeGen.GeneratedRb9ad29e25c8033e5.func0 [{ instructionIndex := 7, field := .thenBranch }, { instructionIndex := 20, field := .elseBranch }, { instructionIndex := 15, field := .thenBranch }, { instructionIndex := 11, field := .thenBranch }]).getD []).drop 53 =
      LeanExeGen.GeneratedRb9ad29e25c8033e5.AnnotationMatches.function_0_erase_copy_0_program ++ ((Project.ProofKit.Annotation.resolve LeanExeGen.GeneratedRb9ad29e25c8033e5.func0 [{ instructionIndex := 7, field := .thenBranch }, { instructionIndex := 20, field := .elseBranch }, { instructionIndex := 15, field := .thenBranch }, { instructionIndex := 11, field := .thenBranch }]).getD []).drop 59 := by
  rfl
