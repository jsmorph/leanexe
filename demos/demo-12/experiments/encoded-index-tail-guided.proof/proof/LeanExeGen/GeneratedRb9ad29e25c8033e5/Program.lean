...
namespace LeanExeGen.GeneratedRb9ad29e25c8033e5
...
def func2Def : Wasm.Function :=
  { params := [], locals := [], body := func2, results := [] }
...
def func3Def : Wasm.Function :=
  { params := [.i64], locals := [.i64], body := func3, results := [.i64] }
...
def func4Def : Wasm.Function :=
  { params := [.i64], locals := [.i64, .i64, .i64, .i64, .i64, .i64, .i64, .i64], body := func4, results := [] }
...
end LeanExeGen.GeneratedRb9ad29e25c8033e5
