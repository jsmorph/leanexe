...
namespace LeanExeGen.GeneratedR40ee67377869b401.AnnotationMatches

def function_0_array_fold_0_program : Wasm.Program :=
  (Project.ProofKit.Annotation.region LeanExeGen.GeneratedR40ee67377869b401.func0 [{ instructionIndex := 7, field := .thenBranch }] 39 65).getD []

theorem function_0_array_fold_0_eq :
    Project.ProofKit.Annotation.region LeanExeGen.GeneratedR40ee67377869b401.func0 [{ instructionIndex := 7, field := .thenBranch }] 39 65 = some function_0_array_fold_0_program := by
  rfl
...
theorem function_0_array_fold_0_setup_eq :
    Project.ProofKit.Annotation.region LeanExeGen.GeneratedR40ee67377869b401.func0
...
def function_0_array_fold_0_body : Project.ProofKit.ScalarTransition.Stmt :=
  .seq (.seq (.seq (.seq (.assign 3 (.bin .bitXor (.get 1) (.get 2))) (.assign 17 (.get 3))) (.assign 16 (.const (0 : UInt64)))) (.assign 1 (.get 17))) (.assign 18 (.const (1 : UInt64)))
...
def function_0_array_fold_0_bodyTransition (v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v18 v19 v20 : UInt64) :
  ...
  some (function_0_array_fold_0_state (v0) (Project.ProofKit.ScalarTransition.U64Op.apply .bitXor (v1) (v2)) (v2) (Project.ProofKit.ScalarTransition.U64Op.apply .bitXor (v1) (v2)) (v4) (v5) (v6) (v7) (v8) (v9) (v10) (v11) (v12) (v13) (v14) (v15) ((0 : UInt64)) (Project.ProofKit.ScalarTransition.U64Op.apply .bitXor (v1) (v2)) ((1 : UInt64)) (v19) (v20))
...
theorem function_0_length_dispatch_0_function_eq :
    LeanExeGen.GeneratedR40ee67377869b401.func0 =
...
end LeanExeGen.GeneratedR40ee67377869b401.AnnotationMatches
