...
namespace LeanExeGen.GeneratedR40ee67377869b401.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  codes := [{ locals := [{ count := 20, type := Wasm.Binary.ValType.i64 }],
...
end LeanExeGen.GeneratedR40ee67377869b401.Artifact.Cache
