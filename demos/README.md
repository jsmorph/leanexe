...
| [Demo 12](demo-12/README.md) | Remove the first zero from a bounded array while preserving order. | Dynamic early-exit search, variable-size allocation, and prefix-plus-shifted-suffix copy test. |
