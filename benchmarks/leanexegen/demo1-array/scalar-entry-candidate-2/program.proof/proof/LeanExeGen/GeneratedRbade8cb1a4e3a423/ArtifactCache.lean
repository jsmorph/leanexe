...
namespace LeanExeGen.GeneratedRbade8cb1a4e3a423.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  functionTypeIndices := [0, 1, 2, 3, 4, 5, 6],
  ...
  exports := [{ name := { bytes := [109, 101, 109, 111, 114, 121], text := "memory" },
              ...
              { name := { bytes := [99, 111, 109, 112, 117, 116, 101], text := "compute" },
                desc := Wasm.Binary.ExportDesc.func 2 },
              { name := { bytes := [97, 108, 108, 111, 99], text := "alloc" }, desc := Wasm.Binary.ExportDesc.func 3 },
              ...
              { name := { bytes := [102, 114, 101, 101], text := "free" }, desc := Wasm.Binary.ExportDesc.func 6 },
  ...
  codes := [{ locals := [{ count := 16, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.i64Const 0,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.i64Const 1,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.value (Wasm.Binary.ValType.i64))
                            [Wasm.Binary.Instr.localGet 3, Wasm.Binary.Instr.i64Const 1, Wasm.Binary.Instr.i64Add]
              ...
              body := [Wasm.Binary.Instr.localGet 0,
                       ...
                       Wasm.Binary.Instr.iff
                         ...
                         [Wasm.Binary.Instr.localGet 0,
                          ...
                          Wasm.Binary.Instr.iff
                            (Wasm.Binary.BlockType.empty)
                            [Wasm.Binary.Instr.i64Const 8, Wasm.Binary.Instr.localSet 9]
                            none,
                          Wasm.Binary.Instr.i64Const 0,
                          Wasm.Binary.Instr.localSet 14,
                          Wasm.Binary.Instr.i64Const 0,
                               ...
                               [Wasm.Binary.Instr.localGet 11,
                                ...
                                Wasm.Binary.Instr.iff
                                  ...
                                  [Wasm.Binary.Instr.localGet 10,
                                   ...
                                   Wasm.Binary.Instr.iff
                                     (Wasm.Binary.BlockType.empty)
                                     [Wasm.Binary.Instr.localGet 13, Wasm.Binary.Instr.globalSet 1]
                          ...
                          Wasm.Binary.Instr.localGet 3,
                          Wasm.Binary.Instr.localSet 4]
                         (some [Wasm.Binary.Instr.localGet 0, Wasm.Binary.Instr.localSet 4]),
                       Wasm.Binary.Instr.localGet 4] },
            { locals := [{ count := 6, type := Wasm.Binary.ValType.i64 }],
              body := [Wasm.Binary.Instr.localGet 0,
                       Wasm.Binary.Instr.i64Const 7,
...
end LeanExeGen.GeneratedRbade8cb1a4e3a423.Artifact.Cache
