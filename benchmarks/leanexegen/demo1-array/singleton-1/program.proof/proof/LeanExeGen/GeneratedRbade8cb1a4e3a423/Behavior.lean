...
theorem artifact_behavior :
  ...
  · obtain ⟨x, hInputEq⟩ := Array.size_eq_one_iff.mp hSingleton
    ...
    change wp LeanExeGen.GeneratedRbade8cb1a4e3a423.«module»
      ...
      { params := [.i64 inputPtr],
        locals := [.i64 x, .i64 (factorCount x), .i64 0, .i64 0,
          .i64 inputPtr, .i64 0, .i64 0, .i64 0, .i64 16, .i64 0,
          .i64 0, .i64 0, .i64 0, .i64 0],
        values := [] } env
    apply Project.ProofKit.FixedArraySingleton.region_result_spec
      LeanExeGen.GeneratedRbade8cb1a4e3a423.«module» env st' _ heapTop allocs
        (factorCount x)
    · rfl
    · rfl
    · rfl
    ...
    · intro hResultArray
      rw [Wasm.wp_nil]
      simp [Project.ProofKit.FixedArraySingleton.resultFrame,
        Project.ProofKit.FixedArrayAllocator.allocFrame,
        LeanExeGen.GeneratedRbade8cb1a4e3a423.func2Def]
      rw [hExpected]
