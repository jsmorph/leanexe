...
theorem function_0_scalar_post_test_loop_0_terminates_with_of_post_test {α : Type}
    (env : Wasm.HostEnv α) (initial : Wasm.Store α)
    (P : Wasm.Store α → List Wasm.Value → Prop) (v0 : UInt64)
    (Inv : Project.ProofKit.ScalarTransition.State → Prop)
    (measure : Project.ProofKit.ScalarTransition.State → Nat)
    (hInit : Inv ((function_0_scalar_post_test_loop_0_state (v0) (v0) ((0 : UInt64)) (v0) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64))).toState))
    (hStep : ∀ current, Inv current →
      ∃ afterBody,
        function_0_scalar_post_test_loop_0_body.eval 12 current = some afterBody ∧
        ∃ result afterCondition,
          function_0_scalar_post_test_loop_0_condition.eval 12 afterBody =
            some (result, afterCondition) ∧
          if result then
            Wasm.wp LeanExeGen.GeneratedR1b9b2027715ddee5.«module»
              (LeanExeGen.GeneratedR1b9b2027715ddee5.func0.drop 11)
              (fun c => match c with
                | .Fallthrough st' s' => P st' (s'.values.take 1)
                | .Return st' vs => P st' (vs.take 1)
                | _ => False)
              initial (afterCondition.toLocals []) env
          else Inv afterCondition ∧ measure afterCondition < measure current) :
    Wasm.TerminatesWith env LeanExeGen.GeneratedR1b9b2027715ddee5.«module» 0
      initial [.i64 v0] P := by
  apply function_0_scalar_post_test_loop_0_terminates_with_of_loop
  simpa only [function_0_scalar_post_test_loop_0_program] using
    (Project.ProofKit.ScalarTransition.postTestProgram_spec
      (condition := function_0_scalar_post_test_loop_0_condition) (body := function_0_scalar_post_test_loop_0_body)
      (scratch := 12)
      (initial := ((function_0_scalar_post_test_loop_0_state (v0) (v0) ((0 : UInt64)) (v0) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64)) ((0 : UInt64))).toState))
      (values := []) (module_ := LeanExeGen.GeneratedR1b9b2027715ddee5.«module»)
      ...
      (Q := fun c => match c with
        ...
        | .Return st' vs => P st' (vs.take 1)
        | _ => False)
      (Inv := Inv) (measure := measure) hInit hStep)
