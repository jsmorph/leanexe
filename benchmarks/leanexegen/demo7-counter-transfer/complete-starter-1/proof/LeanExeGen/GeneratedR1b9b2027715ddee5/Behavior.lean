...
theorem artifact_behavior :
  ...
  · exact hAllocs
  · intro value
    exact LeanExeGen.GeneratedR1b9b2027715ddee5.AnnotationMatches.function_0_scalar_post_test_loop_0_terminates_with_counter_transfer_identity env initial value
  · intro hSize
    rfl
  · intro hSize
