...
namespace LeanExeGen.GeneratedR1b9b2027715ddee5.Artifact.Cache
...
{ sections := [Wasm.Binary.SectionId.type,
  ...
  codes := [{ locals := [{ count := 15, type := Wasm.Binary.ValType.i64 }],
...
end LeanExeGen.GeneratedR1b9b2027715ddee5.Artifact.Cache
